...
@section('contentHeader')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <span>{{ Lang::get('main.lite_version_charge_transaction') }}</span>
            </li>
        </ul>
...
<style>
    ...
    @if(PerUser('lite_version_charge_transaction_add'))
        <div class="row">
            <div class="col-md-12">
                <div class="btn-group pull-right">
                    <a href="{{ URL('admin/lite_version_charge_transaction/create') }}" id="sample_editable_1_new" class="btn green">
    ...
    @endif
    @if(PerUser('lite_version_charge_transaction_view'))
        <div class="row">
...
@section('scriptCode')
    ...
    <script>
        $(document).ready(function () {
            ...
            @if(PerUser('lite_version_charge_transaction_publish'))
            $(document).on('change', '.changeStatues', function () {
                ...
                if (statues) {
                    $.ajax({
                        type: "POST",
                        url: "{{ URL('admin/lite_version_charge_transaction/publish') }}",
            ...
            grid.init({
                ...
                dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                    ...
                    "ajax": {
                        "url": "{{ URL('admin/lite_version_charge_transaction_search') }}", // ajax source
                    },
            ...
            @if(PerUser('lite_version_charge_transaction_delete'))
                    ...
                    buttons: [
                        {
                            ...
                            action: function (dialogItself) {
                                $.ajax({
                                    type: "DELETE",
                                    url: "{{ URL('admin/lite_version_charge_transaction') }}/" + deleted_id,
            ...
            @endif
            @if(PerUser('lite_version_charge_transaction_copy'))
                    ...
                    buttons: [
                        {
                            ...
                            action: function (dialogItself) {
                                $.ajax({
                                    type: "POST",
                                    url: "{{ URL('admin/lite_version_charge_transaction/copy') }}",
                                    data: {"id": copy_id, _token: token},
                                    success: function (msg) {
                                        window.location.href = "charge_transaction";
                                    }
                                });
                            }
                        },
