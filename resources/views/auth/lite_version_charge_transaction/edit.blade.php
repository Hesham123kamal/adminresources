...
@section('contentHeader')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{ URL('/admin/charge_transaction') }}">{{ Lang::get('main.lite_version_charge_transaction') }}</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
    ...
    <div class="row">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                {!! Form::open(['method'=>'PUT','url'=>'admin/lite_version_charge_transaction/'.$transaction->id,'class'=>"form-horizontal",'files'=>true]) !!}
                <div class="form-body">
                ...
                <div class="form-group col-lg-12">
                    ...
                    <div class="input-icon right">
                        <i class="fa"></i>
                        <input type="text" class="form-control" value="{{$transaction->subscrip_type}}" name="subscribe_type" data-required="1"
                ...
                @if($transaction->attach !='')
                    ...
                    <div class="form-group col-lg-12">
                        <label class="control-label">Current Attach</label>
                        <div class="input-icon right">
                            <i class="fa"></i>
                ...
                <div class="form-group col-lg-12" style="margin-top:25px;">
                    ...
                    <input type="checkbox" @if($transaction->courses==1) checked @endif class="make-switch " name="courses" id="courses" value="1"  data-size="small"
                ...
                <div class="form-group col-lg-12" style="margin-top:25px;">
                    ...
                    <input type="checkbox" @if($transaction->webinars==1) checked @endif class="make-switch" name="webinars" id="webinars" value="1" data-size="small"
                           data-on-color="success" data-on-text="{{ Lang::get('main.yes') }}" data-off-color="default"
                           data-off-text="{{ Lang::get('main.no') }}">
                </div>
                ...
                <div class="form-group col-lg-12" style="margin-top:25px;">
                    ...
                    <input type="checkbox" @if($transaction->offline_webinars==1) checked @endif class="make-switch" name="offline_webinars" id="offline_webinars" value="1" data-size="small"
                           data-on-color="success" data-on-text="{{ Lang::get('main.yes') }}" data-off-color="default"
                           data-off-text="{{ Lang::get('main.no') }}">
                </div>
                ...
                <div class="form-group col-lg-12" style="margin-top:25px;">
                    ...
                    <input type="checkbox" @if($transaction->books==1) checked @endif class="make-switch" name="books" id="books" value="1" data-size="small"
                           data-on-color="success" data-on-text="{{ Lang::get('main.yes') }}" data-off-color="default"
                           data-off-text="{{ Lang::get('main.no') }}">
                </div>
                ...
                <div class="form-group col-lg-12" style="margin-top:25px;">
                    ...
                    <input type="checkbox" @if($transaction->successtories==1) checked @endif class="make-switch" name="successtories" id="successtories" value="1" data-size="small"
                           data-on-color="success" data-on-text="{{ Lang::get('main.yes') }}" data-off-color="default"
                           data-off-text="{{ Lang::get('main.no') }}">
                </div>
