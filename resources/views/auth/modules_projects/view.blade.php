...
@section('contentHeader')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <span>{{ Lang::get('main.modules_projects') }}</span>
            </li>
        </ul>
...
@section('content')
    ...
    @if(PerUser('modules_projects_add'))
        <div class="row">
            <div class="col-md-12">
                <div class="btn-group pull-right">
                    <a href="{{ URL('admin/modules_projects/create') }}" id="sample_editable_1_new" class="btn green">
    ...
    @endif
    @if(PerUser('modules_projects_view'))
        <div class="row">
                ...
                <div class="portlet-body">
                    <table class="table table-striped table-bordered table-hover table-checkable" width="100%"
                        ...
                        <tr role="row" class="heading">
                            ...
                            <th width="20%">{{ Lang::get('main.title') }}</th>
                            <th width="10%">{{ Lang::get('main.file') }}</th>
                            <th width="10%">{{ Lang::get('main.active') }}</th>
                            <th width="8%"></th>
                        </tr>
                        <tr role="row" class="filter">
                            ...
                            <td>
                                <select name="module_id" class="module_name form-control form-filter" id="module_id">
                            ...
                            <td>
                                <select name="project_name" class="module_name form-control form-filter" id="project_name">
...
@section('scriptCode')
    ...
    <script>
        $(document).ready(function () {
            ...
            @if(PerUser('modules_projects_active'))
            $(document).on('change','.changeStatues',function(){
                ...
                if(statues){
                    $.ajax({
                        type: "POST",
                        url: "{{ URL('admin/modules_projects/activation') }}",
            ...
            grid.init({
                ...
                onDataLoad: function (grid) {
                    ...
                    $edit_drug.editable({
                        ...
                        url: "{{ URL('admin/modules_projects') }}/" + $edit_drug_status_id + '/editmodules_projectstatus',
                ...
                dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                    ...
                    "ajax": {
                        "url": "{{ URL('admin/modules_projects_search') }}", // ajax source
                    },
            ...
            $(document).on('click', '.confirm_deletion', function (event) {
                ...
                $.ajax(
                    {
                        url: "{{ URL('admin/modules_projects') }}/" + drug_id,
            ...
            @if(PerUser('modules_projects_delete'))
            $(document).on('click', '.delete_this', function (event) {

                var deleted_id = $(this).attr("data-id");
                event.preventDefault();
                BootstrapDialog.show({
                    title: '{{ Lang::get('main.delete').lang::get('main.modules_projects') }}',
                    message: '{{ Lang::get('main.delete_this').lang::get('main.modules_projects') }} ?',
                    buttons: [
                        {
                            ...
                            action: function (dialogItself) {
                                $.ajax({
                                    type: "DELETE",
                                    url: "{{ URL('admin/modules_projects') }}/" + deleted_id,
