    ...
    <div class="row">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                {!! Form::open(['method'=>'POST','url'=>'admin/modules_projects','id'=>'addModules_projectsForm','class'=>"form-horizontal",'files'=>true]) !!}
                <div class="form-body">
                    ...
                    <div class="form-group col-lg-9">
                        ...
                        <select id="name" class="form-control sel2 module_name" required name="name">
                            ...
                            @foreach($mba as $single_mba)
                                <option value="{{ $single_mba->id}}">{{ $single_mba->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="form-group col-lg-12">
                        <label class="control-label" for="file">{{ Lang::get('main.file') }} <span
                                    class="required"> * </span></label>
                        <div class="input-icon right">
                            <i class="fa"></i>
                            <input type="file" class="form-control" value="" id="file" accept="application/pdf,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document,application/vnd.ms-powerpoint,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel"
                                   name="file" data-required="1"
