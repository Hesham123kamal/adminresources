...
@section('contentHeader')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <span>{{ Lang::get('main.site_faq') }}</span>
            </li>
        </ul>
...
<style>
    ...
    @if(PerUser('site_faq_add'))
        <div class="row">
            <div class="col-md-12">
                <div class="btn-group pull-right">
                    <a href="{{ URL('admin/site_faq/create') }}" id="sample_editable_1_new" class="btn green">
                ...
                <div class="portlet-body">
                    <table style=" table-layout: fixed;width: 100%;" class="table table-striped table-bordered table-hover table-checkable" width="100%"
                        ...
                        <tr role="row" class="heading">
                            <th> #</th>
                            <th>{{ Lang::get('main.question') }}</th>
                            <th>{{ Lang::get('main.answer') }}</th>
                        ...
                        <tr role="row" class="filter">
                            ...
                            <td>
                                <input type="text" class="form-control form-filter input-sm" name="question">
                            </td>
                            <td>
                                <input type="text" class="form-control form-filter input-sm" name="answer">
                            </td>
                            <td>
        ...
        $(document).ready(function () {
            ...
            $(document).on('change', '.changeStatues', function () {
                ...
                if (statues) {
                    $.ajax({
                        type: "POST",
                        url: "{{ URL('admin/site_faq/publish') }}",
            ...
            grid.init({
                ...
                dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                    ...
                    "ajax": {
                        "url": "{{ URL('admin/site_faq_search') }}", // ajax source
                    },
            ...
            @if(PerUser('site_faq_delete'))
            $(document).on('click', '.delete_this', function (event) {

                var deleted_id = $(this).attr("data-id");
                event.preventDefault();
                BootstrapDialog.show({
                    title: '{{ Lang::get('main.delete').lang::get('main.site_faq') }}',
                    message: '{{ Lang::get('main.delete_this').lang::get('main.site_faq') }} ?',
                    buttons: [
                        {
                            ...
                            action: function (dialogItself) {
                                $.ajax({
                                    type: "DELETE",
                                    url: "{{ URL('admin/site_faq') }}/" + deleted_id,
