    ...
    <div class="row">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                {!! Form::open(['method'=>'POST','url'=>'admin/site_faq','class'=>"form-horizontal",'files'=>true]) !!}
                <div class="form-body">
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <div class="input-icon right">
                            ...
                            <textarea class="form-control" style="min-height: 300px;"
                                      ...
                                      placeholder="{{ Lang::get('main.enter').Lang::get('main.question') }}">{{old('question')}}</textarea>
                    ...
                    {{--<div class="form-group col-lg-12">--}}
                        ...
                        {{--<div class="input-icon right">--}}
                            ...
                            {{--<textarea class="form-control answer" style="min-height: 300px;"--}}
                                      ...
                                      {{--placeholder="{{ Lang::get('main.enter').Lang::get('main.answer') }}">{{old('answer')}}</textarea>--}}
                        {{--</div>--}}
                    {{--</div>--}}

                    @include('auth/description',['selectors'=>'.answer','labels'=>[Lang::get('main.answer')]])
