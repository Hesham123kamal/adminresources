...
@section('contentHeader')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{ URL('/admin/recruitment_companies') }}">{{ Lang::get('main.recruitment_company') }}</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
    ...
    <!-- END PAGE BAR -->
    <!-- BEGIN PAGE TITLE-->
    <h1 class="page-title"> {{ Lang::get('main.recruitment_company') }}
        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption font-dark">
                    ...
                    <span class="caption-subject bold uppercase">{{ Lang::get('main.recruitment_company') }}</span>
                </div>
                <div class="tools"></div>
            </div>
            <div class="portlet-body">
                {!! Form::open(['method'=>'PUT','url'=>'admin/recruitment_companies/'.$rec_company->id,'class'=>"form-horizontal",'files'=>true]) !!}
                <div class="form-body">
                ...
                <div class="form-group col-lg-9">
                    ...
                    <div class="input-icon right">
                        <i class="fa"></i>
                        <input type="text" class="form-control" value="{{$rec_company->name}}" name="name" data-required="1"
                               placeholder="{{ Lang::get('main.enter').Lang::get('main.name') }}">
                    </div>
                </div>

                <div class="form-group col-lg-3 text-center" style="margin-top:25px;">
                    <input @if($rec_company->published=="yes") checked @endif type="checkbox" class="make-switch" name="published" value="yes" checked data-size="small"
                ...
                <div class="form-group col-lg-12">
                    ...
                    <select name="industry" class="module_name sel2 form-control form-filter">
                        ...
                        @foreach($industries as $id=>$value)
                            <option @if($rec_company->industry_id==$id)  selected="selected"
                ...
                <div class="form-group col-lg-12">
                    <label class="control-label">{{ Lang::get('main.logo') }}</label>
                    <div class="input-icon right">
                        <i class="fa"></i>
                        <img style="width:20%;" src="{{assetURL($rec_company->logo) }}">
                    </div>
                </div>

                <div class="form-group col-lg-12">
                    <label class="control-label" for="logo">{{ Lang::get('main.replace') }} {{ Lang::get('main.logo') }}</label>
                    <div class="input-icon right">
                        <i class="fa"></i>
                        <input type="file" class="form-control" value="" accept="image/*"
                               name="logo" placeholder="{{ Lang::get('main.enter').Lang::get('main.logo') }}">
                    </div>
                </div>
                ...
                <div class="form-group col-lg-12">
                    ...
                    <select name="company_size" class="module_name sel2 form-control form-filter">
                        ...
                        <option @if($rec_company->company_size=='1_10') selected="selected" @endif value="1_10">1-10</option>
                        <option @if($rec_company->company_size=='11_50') selected="selected" @endif value="11_50">11-50</option>
                        <option @if($rec_company->company_size=='51_100') selected="selected" @endif value="51_100">51-100</option>
                        <option @if($rec_company->company_size=='101_500') selected="selected" @endif value="101_500">101-500</option>
                        <option @if($rec_company->company_size=='501_1000') selected="selected" @endif value="501_1000">501-1000</option>
                        <option @if($rec_company->company_size=='more_than_1000') selected="selected" @endif value="more_than_1000">more than 1000</option>
                    </select>
                </div>

                @include('auth/description',['posts' =>[$rec_company->description]])

                <div class="form-group col-lg-12">
                    <label class="control-label" for="website">{{ Lang::get('main.website') }}</label>
                    <div class="input-icon right">
                        <i class="fa"></i>
                        <input type="text" class="form-control" value="{{$rec_company->website}}" name="website" data-required="1"
                ...
                <div class="form-group col-lg-12">
                    ...
                    <div class="input-group date margin-bottom-5" data-date-format="yyyy-mm-dd">
                        <input value="{{$rec_company->founded_year}}" type="text" class="form-control form-filter input-sm founded_year"
                ...
                <div class="form-group col-lg-12">
                    ...
                    <div class="input-icon right">
                        <i class="fa"></i>
                        <input type="text" class="form-control" value="{{$rec_company->facebook}}" name="facebook" data-required="1"
                ...
                <div class="form-group col-lg-12">
                    ...
                    <div class="input-icon right">
                        <i class="fa"></i>
                        <input type="text" class="form-control" value="{{$rec_company->linkedin}}" name="linkedin" data-required="1"
                ...
                <div class="form-group col-lg-12">
                    ...
                    <div class="input-icon right">
                        <i class="fa"></i>
                        <input type="text" class="form-control" value="{{$rec_company->blog}}" name="blog" data-required="1"
                ...
                <div class="form-group col-lg-12">
                    ...
                    <div class="input-icon right">
                        <i class="fa"></i>
                        <input type="text" class="form-control" value="{{$rec_company->twitter}}" name="twitter" data-required="1"
