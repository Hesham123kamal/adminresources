    ...
    <div class="row">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                {!! Form::open(['method'=>'PUT','url'=>'admin/recruitment_currencies/'.$currency->id,'class'=>"form-horizontal"]) !!}
                <div class="form-body">
                ...
                <div class="form-group col-lg-9">
                    ...
                    <div class="input-icon right">
                        <i class="fa"></i>
                        <input type="text" class="form-control" value="{{$currency->name}}" id="name" name="name"
                               data-required="1"
                ...
                <div class="form-group col-lg-3 text-center" style="margin-top:25px;">
                    <input type="checkbox" class="make-switch" name="published" value="yes"
                           @if($currency->published=="yes") checked @endif data-size="small" data-on-color="success"
