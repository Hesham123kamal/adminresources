    ...
    <div class="row">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                {!! Form::open(['method'=>'PUT','url'=>'admin/tpay_price_book/'.$record->id,'class'=>"form-horizontal"]) !!}
                <div class="form-body">
                ...
                <div class="form-group col-lg-12">
                    ...
                    <div class="input-icon right">
                        <i class="fa"></i>
                        <input type="text" class="form-control" value="{{$record->sku}}" id="sku" name="sku" data-required="1"
                               placeholder="{{ Lang::get('main.enter').Lang::get('main.sku') }}">
                    </div>
                </div>
                {{--<div class="form-group col-lg-3 text-center" style="margin-top:25px;">--}}
                    {{--<input type="checkbox" class="make-switch" name="pulished" value="yes"--}}
                           {{--@if($record->published=="yes") checked @endif data-size="small" data-on-color="success"--}}
                ...
                <div class="form-group col-lg-12">
                    ...
                    <select name="country" class="module_name sel2 form-control form-filter"
                        ...
                        @foreach($country as $id=>$name)
                            <option  @if($record->country_id==$id)  selected="selected"
                ...
                <div class="form-group col-lg-12">
                    ...
                    <div class="input-icon right">
                        <i class="fa"></i>
                        <input type="text" class="form-control" value="{{$record->operator_code}}" id="operator_code" name="operator_code"
                               data-required="1"
                ...
                <div class="form-group col-lg-12">
                    ...
                    <div class="input-icon right">
                        <i class="fa"></i>
                        <input type="text" class="form-control" value="{{$record->operator_name}}" id="operator_name" name="operator_name"
                               data-required="1"
                ...
                <div class="form-group col-lg-12">
                    ...
                    <div class="input-icon right">
                        <i class="fa"></i>
                        <input type="text" class="form-control" value="{{$record->currency_symbol}}" id="currency_symbol" name="currency_symbol"
                               data-required="1"
                ...
                <div class="form-group col-lg-12">
                    ...
                    <div class="input-icon right">
                        <i class="fa"></i>
                        <input type="text" class="form-control" value="{{$record->price}}" id="price" name="price"
                               data-required="1"
