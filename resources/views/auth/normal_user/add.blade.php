    ...
    <div class="row">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                {!! Form::open(['method'=>'POST','url'=>'admin/normal_user','class'=>"form-horizontal",'files'=>true]) !!}
                <div class="form-body">
                    ...
                    <div class="col-md-12 form-group">
                        ...
                        <div class="input-group date ped" data-date-format="yyyy-mm-dd">
                            <input type="text" class="form-control" name="payment_expiration_date">
                    ...
                    <div class="col-md-12 form-group">
                        ...
                        <div class="input-group date ped" data-date-format="yyyy-mm-dd">
                            <input type="text" class="form-control" name="demo_expiration_date">
                            <span class="input-group-btn">
                                <button class="btn btn-sm default" type="button">
                                    <i class="fa fa-calendar"></i>
                                </button>
