...
@section('contentHeader')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <span>{{ Lang::get('main.diplomas_charge_transaction_suspend_log') }}</span>
            </li>
        </ul>
...
<style>
    ...
    @if(PerUser('diplomas_charge_transaction_suspend_log_add'))
        <div class="row">
            <div class="col-md-12">
                <div class="btn-group pull-right">
                    <a href="{{ URL('admin/dctsl/create') }}" id="sample_editable_1_new" class="btn green">
    ...
    @endif
    @if(PerUser('diplomas_charge_transaction_suspend_log_view'))
        <div class="row">
...
@section('scriptCode')
    ...
    <script>
        $(document).ready(function () {
            ...
            {{--@if(PerUser('diplomas_charge_transaction_suspend_log_publish'))--}}
            ...
            grid.init({
                ...
                dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                    ...
                    "ajax": {
                        "url": "{{ URL('admin/dctsl_search') }}", // ajax source
                    },
            ...
            @if(PerUser('diplomas_charge_transaction_suspend_log_delete'))
            $(document).on('click', '.delete_this', function (event) {

                var deleted_id = $(this).attr("data-id");
                event.preventDefault();
                BootstrapDialog.show({
                    title: '{{ Lang::get('main.delete').lang::get('main.diploma_charge_transaction_suspend_log') }}',
                    message: '{{ Lang::get('main.delete_this').lang::get('main.diploma_charge_transaction_suspend_log') }} ?',
                    buttons: [
                        {
                            ...
                            action: function (dialogItself) {
                                $.ajax({
                                    type: "DELETE",
                                    url: "{{ URL('admin/dctsl') }}/" + deleted_id,
