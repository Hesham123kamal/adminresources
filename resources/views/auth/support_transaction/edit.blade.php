    ...
    <div class="row">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                {!! Form::open(['method'=>'PUT','url'=>'admin/support_transaction/'.$transaction->id,'class'=>"form-horizontal"]) !!}
                <div class="form-body">
                ...
                <div class="form-group col-lg-6">
                    ...
                    <select name="employee" class="module_name sel2 form-control form-filter">
                        ...
                        @foreach($employees as $id=>$name)
                            <option @if($transaction->employe_id==$id) selected="selected" @endif value="{{$id}}">{{$name}}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="form-group col-lg-6 text-center" style="margin-top:25px;">
                    ...
                    <input type="checkbox" class="make-switch" name="send_credentials" value="1"
                           @if($transaction->send_credentials==1) checked @endif data-size="small" data-on-color="success"
                           data-on-text="{{ Lang::get('main.yes') }}" data-off-color="default" data-off-text="{{ Lang::get('main.no') }}">
                </div>
                <div class="form-group col-lg-12">
                    ...
                    <div class="input-icon right">
                        <i class="fa"></i>
                        <input type="text" class="form-control" value="{{$transaction->old_email}}" name="old_email" data-required="1"
                ...
                <div class="form-group col-lg-12">
                    ...
                    <div class="input-icon right">
                        <i class="fa"></i>
                        <input type="text" class="form-control" value="{{$transaction->new_email}}" name="new_email" data-required="1"
                ...
                <div class="form-group col-lg-12">
                    ...
                    <div class="input-icon right">
                        <i class="fa"></i>
                        <input type="text" class="form-control" value="{{$transaction->old_phone}}" name="old_phone" data-required="1"
                ...
                <div class="form-group col-lg-12">
                    ...
                    <div class="input-icon right">
                        <i class="fa"></i>
                        <input type="text" class="form-control" value="{{$transaction->new_phone}}" name="new_phone" data-required="1"
