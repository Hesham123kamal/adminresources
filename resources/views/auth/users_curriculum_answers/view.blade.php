...
@section('contentHeader')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <span>{{ Lang::get('main.users_curriculum_answers') }}</span>
            </li>
        </ul>
...
<style>
    ...
    @if(PerUser('users_curriculum_answers_add'))
        <div class="row">
            <div class="col-md-12">
                <div class="btn-group pull-right">
                    <a href="{{ URL('admin/users_curriculum_answers/create') }}" id="sample_editable_1_new" class="btn green">
    ...
    @endif
    @if(PerUser('users_curriculum_answers_view')) 
        <div class="row">
                ...
                <div class="portlet-body">
                    <table style=" table-layout: fixed;width: 100%;" class="table table-striped table-bordered table-hover table-checkable" width="100%"
                        ...
                        <tr role="row" class="heading">
                            ...
                            <th>{{ Lang::get('main.curriculum_id') }}</th>
                            <th>{{ Lang::get('main.right_answers') }}</th>
                            <th>{{ Lang::get('main.wrong_answers') }}</th>
...
{{--                            <th>{{ Lang::get('main.published') }}</th>--}}
                        ...
                        <tr role="row" class="filter">
                            ...
                            <td>
                                <input type="text" class="form-control form-filter input-sm" name="curriculum_id">
                            </td>
                            <td>
                                <input type="text" class="form-control form-filter input-sm" name="right_answers">
                            </td>
                            <td>
                                <input type="text" class="form-control form-filter input-sm" name="wrong_answers">
                            </td>
                            <td>
...
@section('scriptCode')
    ...
    <script>
        $(document).ready(function () {
            ...
            {{--@if(PerUser('users_curriculum_answers_publish'))--}}
            {{--$(document).on('change', '.changeStatues', function () {--}}
                ...
                {{--if (statues) {--}}
                    {{--$.ajax({--}}
                        {{--type: "POST",--}}
                        {{--url: "{{ URL('admin/users_curriculum_answers/publish') }}",--}}
            ...
            grid.init({
                ...
                dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                    ...
                    "ajax": {
                        "url": "{{ URL('admin/users_curriculum_answers_search') }}", // ajax source
                    },
            ...
            @if(PerUser('users_curriculum_answers_delete'))
                    ...
                    buttons: [
                        {
                            ...
                            action: function (dialogItself) {
                                $.ajax({
                                    type: "DELETE",
                                    url: "{{ URL('admin/users_curriculum_answers') }}/" + deleted_id,
