...
@section('contentHeader')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <span>{{ Lang::get('main.modules_users_summary') }}</span>
            </li>
        </ul>
    ...
    <!-- END PAGE BAR -->
    <!-- BEGIN PAGE TITLE-->
    <h1 class="page-title"> {{ Lang::get('main.modules_users_summary') }}
...
<style>
    ...
    @if(PerUser('modules_users_summary_view'))
        <div class="row">
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        <i class="icon-users font-dark"></i>
                        <span class="caption-subject bold uppercase">{{ Lang::get('main.modules_users_summary') }}</span>
                    </div>
                    <div class="tools"></div>
                </div>
                <div class="portlet-body">
                    <table style=" table-layout: fixed;width: 100%;" class="table table-striped table-bordered table-hover table-checkable" width="100%"
                        ...
                        <tr role="row" class="heading">
                            ...
                            <th>{{ Lang::get('main.module') }}</th>
                            <th>{{ Lang::get('main.project_name') }}</th>
                            <th>{{ Lang::get('main.project') }}</th>
                            <th>{{ Lang::get('main.exam') }}</th>
                            <th>{{ Lang::get('main.progress') }}</th>
                            <th>{{ Lang::get('main.download_project_date') }}</th>
                            <th>{{ Lang::get('main.project_upload') }}</th>
                        ...
                        <tr role="row" class="filter">
                            ...
                            <td>
                                <select name="module" class="module_name sel2 form-control form-filter">
                                    <option value=" ">{{ Lang::get('main.select') }}{{ Lang::get('main.module_name') }}</option>
                            ...
                            <td>
                                <input type="text" class="form-control form-filter input-sm" name="proj">
                            </td>
                            <td>
                                <input type="text" class="form-control form-filter input-sm" name="exam">
                            </td>
                            <td>
                                <input type="text" class="form-control form-filter input-sm" name="progress">
                            </td>
                            <td>
                                <div class="input-group date fromToDate margin-bottom-5" data-date-format="yyyy-mm-dd">
                                    <input type="text" class="form-control form-filter input-sm"
                                           name="download_from" placeholder="{{ Lang::get('main.from') }}">
                                ...
                                <div class="input-group date fromToDate" data-date-format="yyyy-mm-dd">
                                    <input type="text" class="form-control form-filter input-sm"
                                           name="download_to" placeholder="{{ Lang::get('main.to') }}">
                                    <span class="input-group-btn">
                                            <button class="btn btn-sm default" type="button">
                                                <i class="fa fa-calendar"></i>
                                            </button>
                            ...
                            <td>
                                <input type="number" class="form-control form-filter input-sm" name="project_upload">
                            </td>
                            <td>
                                <div class="input-group date fromToDate margin-bottom-5" data-date-format="yyyy-mm-dd">
                                    <input type="text" class="form-control form-filter input-sm"
        ...
        $(document).ready(function () {
            ...
            grid.init({
                ...
                dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                    ...
                    "ajax": {
                        "url": "{{ URL('admin/modules_users_summary_search') }}", // ajax source
                    },
