...
@section('contentHeader')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <span>{{ Lang::get('main.apple_users_charge_transactions') }}</span>
            </li>
        </ul>
...
<style>
    ...
    @if(PerUser('apple_users_charge_transactions_add'))
        <div class="row">
            <div class="col-md-12">
                <div class="btn-group pull-right">
                    <a href="{{ URL('admin/apple_users_charge_transactions/create') }}" id="sample_editable_1_new" class="btn green">
    ...
    @endif
    @if(PerUser('apple_users_charge_transactions_view'))
        <div class="row">
                        ...
                        <tr role="row" class="filter">
                            ...
                            <td>
                                <select name="type" class="module_name sel2 form-control form-filter">
                                    ...
                                    <option value="charge_transaction">charge transaction</option>
                                    <option value="diplomas_charge_transaction">diplomas charge transaction</option>
                                    <option value="mba_charge_transaction">mba charge transaction</option>
                                    <option value="diplomas">diplomas</option>
                                    <option value="courses">courses</option>
                                </select>
                            </td>
                            <td>
                                <input type="text" class="form-control form-filter input-sm" name="type_id">
                            </td>
                            <td>
        ...
        $(document).ready(function () {
            ...
            grid.init({
                ...
                dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                    ...
                    "ajax": {
                        "url": "{{ URL('admin/apple_users_charge_transactions_search') }}", // ajax source
                    },
            ...
            @if(PerUser('apple_users_charge_transactions_delete'))
            $(document).on('click', '.delete_this', function (event) {

                var deleted_id = $(this).attr("data-id");
                event.preventDefault();
                BootstrapDialog.show({
                    title: '{{ Lang::get('main.delete').lang::get('main.apple_users_charge_transaction') }}',
                    message: '{{ Lang::get('main.delete_this').lang::get('main.apple_users_charge_transaction') }} ?',
                    buttons: [
                        {
                            ...
                            action: function (dialogItself) {
                                $.ajax({
                                    type: "DELETE",
                                    url: "{{ URL('admin/apple_users_charge_transactions') }}/" + deleted_id,
