    ...
    <div class="row">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                {!! Form::open(['method'=>'POST','url'=>'admin/apple_users_charge_transactions','class'=>"form-horizontal"]) !!}
                <div class="form-body">
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <div class="input-group date margin-bottom-5" data-date-format="yyyy-mm-dd">
                            <input type="text" value="{{ old('start_date') }}" class="form-control form-filter input-sm dd"
                    ...
                    <div class="form-group col-lg-12">
                        <label class="control-label" for="end_date">{{ Lang::get('main.end_date') }} <span
                                    class="required"> * </span></label>
                        <div class="input-group date margin-bottom-5" data-date-format="yyyy-mm-dd">
                            <input type="text" value="{{ old('end_date') }}" class="form-control form-filter input-sm dd"
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <div class="input-icon right">
                            <i class="fa"></i>
                            <input type="text" class="form-control" value="{{ old('quantity') }}" name="quantity" data-required="1"
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <div class="input-icon right">
                            ...
                            <select class="form-control sel2" name="type" id="type">
                                ...
                                <option @if(old('type')=='charge_transaction') selected="selected" @endif value="charge_transaction">charge_transaction</option>
                                <option @if(old('type')=='diplomas_charge_transaction') selected="selected" @endif value="diplomas_charge_transaction">diplomas_charge_transaction</option>
                                <option @if(old('type')=='mba_charge_transaction') selected="selected" @endif value="mba_charge_transaction">mba_charge_transaction</option>
                                <option @if(old('type')=='diplomas') selected="selected" @endif value="diplomas">diplomas</option>
                                <option @if(old('type')=='courses') selected="selected" @endif value="courses">courses</option>
                            </select>
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <div class="input-icon right">
                            <i class="fa"></i>
                            <input type="text" class="form-control" value="{{ old('type_id') }}" name="type_id" data-required="1"
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <div class="input-icon right">
                            <i class="fa"></i>
                            <input type="text" class="form-control" value="{{ old('product_id') }}" name="product_id" data-required="1"
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <div class="input-icon right">
                            <i class="fa"></i>
                            <input type="text" class="form-control" value="{{ old('transaction_id') }}" name="transaction_id" data-required="1"
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <div class="input-icon right">
                            <i class="fa"></i>
                            <input type="text" class="form-control" value="{{ old('original_transaction_id') }}" name="original_transaction_id" data-required="1"
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <div class="input-icon right">
                            <i class="fa"></i>
                            <input type="text" class="form-control" value="{{ old('purchase_date') }}" name="purchase_date" data-required="1"
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <div class="input-icon right">
                            <i class="fa"></i>
                            <input type="text" class="form-control" value="{{ old('purchase_date_ms') }}" name="purchase_date_ms" data-required="1"
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <div class="input-icon right">
                            <i class="fa"></i>
                            <input type="text" class="form-control" value="{{ old('purchase_date_pst') }}" name="purchase_date_pst" data-required="1"
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <div class="input-icon right">
                            <i class="fa"></i>
                            <input type="text" class="form-control" value="{{ old('original_purchase_date') }}" name="original_purchase_date" data-required="1"
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <div class="input-icon right">
                            <i class="fa"></i>
                            <input type="text" class="form-control" value="{{ old('original_purchase_date_ms') }}" name="original_purchase_date_ms" data-required="1"
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <div class="input-icon right">
                            <i class="fa"></i>
                            <input type="text" class="form-control" value="{{ old('original_purchase_date_pst') }}" name="original_purchase_date_pst" data-required="1"
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <div class="input-icon right">
                            ...
                            <select class="form-control sel2" name="is_trial_period" id="is_trial_period">
                                ...
                                <option @if(old('is_trial_period')=='true') selected="selected" @endif value="true">@lang('main.true')</option>
                                <option @if(old('is_trial_period')=='false') selected="selected" @endif value="false">@lang('main.false')</option>
                            </select>
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <select name="apple_user_id" class="module_name sel2 form-control form-filter"
                            ...
                            @foreach($apple_users as $apple_user)
                                <option value="{{$apple_user}}">{{$apple_user}}</option>
                            @endforeach
                        </select>
                    </div>
