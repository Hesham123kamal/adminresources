...
@section('contentHeader')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{ URL('/admin/courses_views') }}">{{ Lang::get('main.courses_views') }}</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
    ...
    <div class="row">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                {!! Form::open(['method'=>'PUT','url'=>'admin/courses_views/'.$course_view->id,'class'=>"form-horizontal"]) !!}
                <div class="form-body">
                ...
                <div class="form-group col-lg-12">
                    ...
                    <select name="course" class="module_name sel2 form-control form-filter">
                        ...
                        @foreach($courses as $id=>$name)
                            <option @if($course_view->course_id==$id) selected="selected" @endif value="{{$id}}">{{$name}}</option>
                        @endforeach
                    </select>
                </div>
                {{--<div class="form-group col-lg-3 text-center" style="margin-top:25px;">--}}
                    {{--<input type="checkbox" class="make-switch" name="published" value="yes"--}}
                           {{--@if($course_view->published=="yes") checked @endif data-size="small" data-on-color="success"--}}
                ...
                <div class="form-group col-lg-12">
                    ...
                    <div class="input-icon right">
                        <i class="fa"></i>
                        <input type="text" class="form-control" value="{{$course_view->count}}" name="count" data-required="1"
        ...
        $(document).ready(function () {
            $('#user').keyup(function(){
                ...
                if(query!=''){
                    ...
                    $.ajax({
                        type: "POST",
                        url: "{{ URL('admin/courses_views/autoCompleteUsers') }}",
