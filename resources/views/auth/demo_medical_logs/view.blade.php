...
@section('contentHeader')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <span>{{ Lang::get('main.demo_medical_logs') }}</span>
            </li>
        </ul>
...
<style>
    ...
    @if(PerUser('demo_medical_logs_add'))
        <div class="row">
            <div class="col-md-12">
                <div class="btn-group pull-right">
                    <a href="{{ URL('admin/demo_medical_logs/create') }}" id="sample_editable_1_new" class="btn green">
    ...
    @endif
    @if(PerUser('demo_medical_logs_view'))
        <div class="row">
                        ...
                        <tr role="row" class="filter">
                            ...
                            <td>
                                <select name="type" class="module_name sel2 form-control form-filter">
                                    ...
                                    <option value="7_days">{{ Lang::get('main.7_days') }}</option>
                                    <option value="2_days">{{ Lang::get('main.2_days') }}</option>
                                </select>
                            </td>
                            <td>
                                <div class="input-group date fromToDate margin-bottom-5" data-date-format="yyyy-mm-dd">
                                    <input type="text" class="form-control form-filter input-sm"
                                           name="start_time_from" placeholder="{{ Lang::get('main.from') }}">
                                ...
                                <div class="input-group date fromToDate" data-date-format="yyyy-mm-dd">
                                    <input type="text" class="form-control form-filter input-sm"
                                           name="start_time_to" placeholder="{{ Lang::get('main.to') }}">
                                    <span class="input-group-btn">
                                            <button class="btn btn-sm default" type="button">
                                                <i class="fa fa-calendar"></i>
                                            </button>
                            ...
                            <td>
                                <div class="input-group date fromToDate margin-bottom-5" data-date-format="yyyy-mm-dd">
                                    <input type="text" class="form-control form-filter input-sm"
                                           name="end_time_from" placeholder="{{ Lang::get('main.from') }}">
                                    <span class="input-group-btn">
                                            <button class="btn btn-sm default" type="button">
                                                <i class="fa fa-calendar"></i>
                                            </button>
                                ...
                                <div class="input-group date fromToDate" data-date-format="yyyy-mm-dd">
                                    <input type="text" class="form-control form-filter input-sm"
                                           name="end_time_to" placeholder="{{ Lang::get('main.to') }}">
                                    <span class="input-group-btn">
                                            <button class="btn btn-sm default" type="button">
                                                <i class="fa fa-calendar"></i>
                                            </button>
        ...
        $(document).ready(function () {
            ...
            grid.init({
                ...
                dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                    ...
                    "ajax": {
                        "url": "{{ URL('admin/demo_medical_logs_search') }}", // ajax source
                    },
            ...
            @if(PerUser('demo_medical_logs_delete'))
            $(document).on('click', '.delete_this', function (demo_medical_log) {

                var deleted_id = $(this).attr("data-id");
                event.preventDefault();
                BootstrapDialog.show({
                    title: '{{ Lang::get('main.delete').lang::get('main.demo_medical_log') }}',
                    message: '{{ Lang::get('main.delete_this').lang::get('main.demo_medical_log') }} ?',
                    buttons: [
                        {
                            ...
                            action: function (dialogItself) {
                                $.ajax({
                                    type: "DELETE",
                                    url: "{{ URL('admin/demo_medical_logs') }}/" + deleted_id,
