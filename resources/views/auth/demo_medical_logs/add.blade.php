    ...
    <div class="row">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                {!! Form::open(['method'=>'POST','url'=>'admin/demo_medical_logs','class'=>"form-horizontal",'files'=>true]) !!}
                <div class="form-body">
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <select name="type" class="module_name sel2 form-control form-filter">
                            ...
                            <option @if(old('type')=='7_days') selected="selected" @endif value="7_days">{{ Lang::get('main.7_days') }}</option>
                            <option @if(old('type')=='2_days') selected="selected" @endif value="2_days">{{ Lang::get('main.2_days') }}</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <div class="input-group date margin-bottom-5" data-date-format="yyyy-mm-dd">
                            <input type="text" class="form-control form-filter input-sm date_field"
                                   name="start_date" placeholder="{{ Lang::get('main.start_date') }}" value="{{old('start_date')}}">
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <div class="input-group date margin-bottom-5" data-date-format="yyyy-mm-dd">
                            <input type="text" class="form-control form-filter input-sm date_field"
                                   name="end_date" placeholder="{{ Lang::get('main.end_date') }}" value="{{old('end_date')}}">
                            <span class="input-group-btn">
                                                <button class="btn btn-sm default" type="button">
                                                    <i class="fa fa-calendar"></i>
                                                </button>
