...
@if(PerUser('automation_add'))
    <div class="row">
        <div class="col-md-12">
            <div class="btn-group pull-right">
                <a href="{{ URL('admin/automation/create') }}" id="sample_editable_1_new" class="btn green">
                ...
                <div class="portlet-body">
                    <table style=" table-layout: fixed;width: 100%;" class="table table-striped table-bordered table-hover table-checkable" width="100%"
                        ...
                        <tr role="row" class="heading">
                            ...
                            <th>{{ Lang::get('main.package') }}</th>
                            <th>{{ Lang::get('main.payment_method') }}</th>
                            <th>{{ Lang::get('main.shipping_address') }}</th>
                            <th>{{ Lang::get('main.bank_transfer') }}</th>
                        ...
                        <tr role="row" class="filter">
                            ...
                            <td>
                                <input type="text" class="form-control form-filter input-sm" name="package">
                            </td>
                            <td>
                                <input type="text" class="form-control form-filter input-sm" name="payment_method">
                            </td>
                            <td>
                                <input type="text" class="form-control form-filter input-sm" name="shipping_address">
                            </td>
                            <td>
                                <input type="text" class="form-control form-filter input-sm" name="bank_transfer">
                            </td>
                            <td>
