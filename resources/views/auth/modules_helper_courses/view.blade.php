...
@section('contentHeader')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <span>{{ Lang::get('main.modules_helper_courses') }}</span>
            </li>
        </ul>
...
@section('content')
    ...
    @if(PerUser('modules_helper_courses_add'))
        <div class="row">
            <div class="col-md-12">
                <div class="btn-group pull-right">
                    <a href="{{ URL('admin/modules_helper_courses/create') }}" id="sample_editable_1_new" class="btn green">
    ...
    @endif
    @if(PerUser('modules_helper_courses_view'))
        <div class="row">
                ...
                <div class="portlet-body">
                    <table class="table table-striped table-bordered table-hover table-checkable" width="100%"
                        ...
                        <tr role="row" class="filter">
                            ...
                            <td>
                                <select name="course_name" class="module_name sel2 form-control form-filter" id="course_name">
                                    <option value=" ">{{ Lang::get('main.select') }}{{ Lang::get('main.course_name') }}</option>
...
@section('scriptCode')
    ...
    <script>
        $(document).ready(function () {
            ...
            @if(PerUser('modules_helper_courses_active'))
            $(document).on('change','.changeStatues',function(){
                ...
                if(statues){
                    $.ajax({
                        type: "POST",
                        url: "{{ URL('admin/modules_helper_courses/activation') }}",
            ...
            grid.init({
                ...
                onDataLoad: function (grid) {
                    ...
                    $edit_drug.editable({
                        ...
                        url: "{{ URL('admin/modules_helper_courses') }}/" + $edit_drug_status_id + '/editmodules_projectstatus',
                ...
                dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                    ...
                    "ajax": {
                        "url": "{{ URL('admin/modules_helper_courses_search') }}", // ajax source
                    },
            ...
            $(document).on('click', '.confirm_deletion', function (event) {
                ...
                $.ajax(
                    {
                        url: "{{ URL('admin/modules_helper_courses') }}/" + drug_id,
            ...
            @if(PerUser('modules_helper_courses_delete'))
            $(document).on('click', '.delete_this', function (event) {

                var deleted_id = $(this).attr("data-id");
                event.preventDefault();
                BootstrapDialog.show({
                    title: '{{ Lang::get('main.delete').lang::get('main.modules_helper_courses') }}',
                    message: '{{ Lang::get('main.delete_this').lang::get('main.modules_helper_courses') }} ?',
                    buttons: [
                        {
                            ...
                            action: function (dialogItself) {
                                $.ajax({
                                    type: "DELETE",
                                    url: "{{ URL('admin/modules_helper_courses') }}/" + deleted_id,
