...
@section('contentHeader')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{ URL('/admin/dct') }}">{{ Lang::get('main.diplomas_charge_transaction') }}</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
    ...
    <div class="row">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                {!! Form::open(['method'=>'PUT','url'=>'admin/dct/'.$transaction->id,'class'=>"form-horizontal",'files'=>true]) !!}
                <div class="form-body">
        ...
        $(document).ready(function () {
            ...
            $('#user').keyup(function(){
                ...
                if(query!=''){
                    ...
                    $.ajax({
                        type: "POST",
                        url: "{{ URL('admin/dct/autoCompleteUsers') }}",
