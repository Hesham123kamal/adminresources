    ...
    <div class="row">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                {!! Form::open(['method'=>'POST','url'=>'admin/webinars','id'=>'addwebinarsForm','class'=>"form-horizontal",'files'=>true]) !!}
                <div class="form-body">
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <textarea class="form-control short_description" style="min-height: 300px;"
                                  ...
                                  placeholder="{{ Lang::get('main.enter').Lang::get('main.short_description') }}">{!! old('short_description') !!}</textarea>
                    </div>
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <div class="input-icon right">
                            <i class="fa"></i>
                            <input type="text" class="form-control" value="{{ old('v_url') }}" id="v_url" name="v_url" data-required="1"
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <div class="input-icon right">
                            <i class="fa"></i>
                            <input type="text" class="form-control" value="{{ old('audio_link') }}" name="audio_link" data-required="1"
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <div class="input-icon right">
                            <i class="fa"></i>
                            <input type="file" class="form-control" id="pic" accept="image/*"
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <div class="input-group date fromToDate margin-bottom-5" data-date-format="yyyy-mm-dd">
                            <input type="text" value="{{ old('duetime') }}" class="form-control form-filter input-sm" readonly
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <select name="instructors" class="module_name sel2 form-control form-filter"
                            ...
                            @foreach($instructors as $instructor)
                                <option @if(old('instructors')==$instructor->id) selected="selected" @endif value="{{$instructor->id}}">{{$instructor->name}}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <select name="location" class="module_name sel2 form-control form-filter"
                            ...
                            <option @if(old('location')=='egy') selected="selected" @endif value="egy">EGP</option>
                            <option @if(old('location')=='ksa') selected="selected" @endif value="ksa">KSA</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <select name="type" class="module_name sel2 form-control form-filter"
                            ...
                            <option @if(old('type')=='online') selected="selected" @endif value="online">Online</option>
                            <option @if(old('type')=='offline') selected="selected" @endif value="offline">Offline</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <select name="parent_id" class="module_name sel2 form-control form-filter" id="parent_id">
                            ...
                            @foreach($parent_webinars as $parent_webinar)
                                <option @if(old('parent_id')==$parent_webinar->id) selected="selected" @endif value="{{$parent_webinar->id}}">{{$parent_webinar->name}}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <select name="isfree" class="module_name sel2 form-control form-filter"
                            ...
                            <option @if(old('isfree')=='no') selected="selected" @endif value="no">no</option>
                            <option @if(old('isfree')=='yes') selected="selected" @endif value="yes">yes</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <textarea class="form-control meta_description" style="min-height: 300px;"
                                  ...
                                  placeholder="{{ Lang::get('main.enter').Lang::get('main.meta_description') }}">{!! old('meta_description') !!}</textarea>
                    </div>
