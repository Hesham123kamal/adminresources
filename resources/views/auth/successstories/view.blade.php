...
@section('contentHeader')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <span>{{ Lang::get('main.successstories') }}</span>
            </li>
        </ul>
...
@section('content')
    ...
    @if(PerUser('successstories_add'))
        <div class="row">
            <div class="col-md-12">
                <div class="btn-group pull-right">
                    <a href="{{ URL('admin/successstories/create') }}" id="sample_editable_1_new" class="btn green">
    ...
    @endif
    @if(PerUser('successstories_view'))
        <div class="row">
                ...
                <div class="portlet-body">
                    <table class="table table-striped table-bordered table-hover dt-responsive" width="100%"
                        ...
                        <tr role="row" class="heading">
                            ...
                            <th width="10%">{{ Lang::get('main.instructor') }}</th>
                        ...
                        <tr role="row" class="filter">
                            ...
                            <td>
                                <input type="text" class="form-control form-filter input-sm" name="instructor">
                            </td>
                            <td>
...
@section('scriptCode')
    ...
    <script>
        $(document).ready(function () {
            ...
            @if(PerUser('successstories_publish'))
            $(document).on('change', '.changeStatues', function () {
                ...
                if (statues) {
                    $.ajax({
                        type: "POST",
                        url: "{{ URL('admin/successstories/publish') }}",
            ...
            grid.init({
                ...
                onDataLoad: function (grid) {
                    ...
                    $edit_drug.editable({
                        ...
                        url: "{{ URL('admin/successstories') }}/" + $edit_drug_status_id + '/editsuccessstoriestatus',
                ...
                dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                    ...
                    "ajax": {
                        "url": "{{ URL('admin/successstories_search') }}", // ajax source
                    },
            ...
            $(document).on('click', '.confirm_deletion', function (event) {
                ...
                $.ajax(
                    {
                        url: "{{ URL('admin/successstories') }}/" + drug_id,
            ...
            @if(PerUser('successstories_delete'))
            $(document).on('click', '.delete_this', function (event) {

                var deleted_id = $(this).attr("data-id");
                event.preventDefault();
                BootstrapDialog.show({
                    title: '{{ Lang::get('main.delete').lang::get('main.successtory') }}',
                    message: '{{ Lang::get('main.delete_this').lang::get('main.successtory') }} ?',
                    buttons: [
                        {
                            ...
                            action: function (dialogItself) {
                                $.ajax({
                                    type: "DELETE",
                                    url: "{{ URL('admin/successstories') }}/" + deleted_id,
