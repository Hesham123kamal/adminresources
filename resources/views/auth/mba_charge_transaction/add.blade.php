...
@section('contentHeader')
    ...
    <!-- END PAGE BAR -->
    <!-- BEGIN PAGE TITLE-->
    <h1 class="page-title"> {{ Lang::get('main.mba_charge_transaction') }}
    ...
    <div class="row">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                {!! Form::open(['method'=>'POST','url'=>'admin/mba_charge_transaction','class'=>"form-horizontal",'files'=>true]) !!}
                <div class="form-body">
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <select name="mba" class="module_name form-control form-filter">
                            ...
                            @foreach($mbas as $id=>$name)
                                <option @if(old('mba')==$id) selected="selected" @endif value="{{$id}}">{{$name}}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <div class="input-icon right">
                            <i class="fa"></i>
                            <input type="text" class="form-control" value="{{ old('mba_price') }}" name="mba_price" data-required="1"
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <select name="subscribe_type" class="module_name sel2 form-control form-filter">
                            ...
                            <option @if(old('subscribe_type')=='mba_free') selected="selected" @endif value="mba_free">free</option>
                            <option @if(old('subscribe_type')=='mba_paid') selected="selected" @endif value="mba_paid">paid</option>
                            <option @if(old('subscribe_type')=='mba_onlinepayment') selected="selected" @endif value="mba_onlinepayment">online payment</option>
                        </select>
                    </div>
