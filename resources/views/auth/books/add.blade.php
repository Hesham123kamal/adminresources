    ...
    <div class="row">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                {!! Form::open(['method'=>'POST','url'=>'admin/books','id'=>'addBooksForm','class'=>"form-horizontal",'files'=>true]) !!}
                <div class="form-body">
                    ...
                    @include('auth/description',['selectors'=>'.description,.description_en','labels'=>[Lang::get('main.description'),Lang::get('main.en_description')],'not_required'=>true])
                    ...
                    <div class="form-group col-lg-12">
                        <label class="control-label" for="book">{{ Lang::get('main.book') }} <span
                                    class="required"> * </span></label>
                        <div class="input-icon right">
                            <i class="fa"></i>
                            <input type="file" class="form-control" value="" id="book" accept="application/pdf"
                                   name="book" data-required="1"
...
@section('scriptCode')
    <script>
        function validate(formData, jqForm, options) {
            var form = jqForm[0];
            if (!form.book.value) {
                alert(" {{ Lang::get('main.select') }}{{ Lang::get('main.book') }}");
                return false;
            }
        }
