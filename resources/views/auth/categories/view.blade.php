...
@section('contentHeader')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <span>{{ Lang::get('main.categories') }}</span>
            </li>
        </ul>
...
@section('content')
    ...
    @if(PerUser('categories_add'))
        <div class="row">
            <div class="col-md-12">
                <div class="btn-group pull-right">
                    <a href="{{ URL('admin/categories/create') }}" id="sample_editable_1_new" class="btn green">
                ...
                <div class="portlet-body">
                    <table class="table table-striped table-bordered table-hover dt-responsive" width="100%"
                        ...
                        <tr role="row" class="heading">
                            ...
                            <th width="20%">{{ Lang::get('main.pic') }}</th>
        ...
        $(document).ready(function () {
            ...
            grid.init({
                ...
                onDataLoad: function (grid) {
                    ...
                    {{--$edit_drug.editable({--}}
                        {{--source: [--}}
                            ...
                            {{--}--}}
                        {{--],--}}
                        {{--url: "{{ URL('admin/categories') }}/" + $edit_drug_status_id + '/editsuccessstoriestatus',--}}
                ...
                dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                    ...
                    "ajax": {
                        "url": "{{ URL('admin/categories_search') }}", // ajax source
                    },
            ...
            $(document).on('click', '.confirm_deletion', function (event) {
                ...
                $.ajax(
                    {
                        url: "{{ URL('admin/categories') }}/" + drug_id,
            ...
            @if(PerUser('categories_delete'))
            $(document).on('click', '.delete_this', function (event) {

                var deleted_id = $(this).attr("data-id");
                event.preventDefault();
                BootstrapDialog.show({
                    title: '{{ Lang::get('main.delete').lang::get('main.categories') }}',
                    message: '{{ Lang::get('main.delete_this').lang::get('main.categories') }} ?',
                    buttons: [
                        {
                            ...
                            action: function (dialogItself) {
                                $.ajax({
                                    type: "DELETE",
                                    url: "{{ URL('admin/categories') }}/" + deleted_id,
