...
@section('contentHeader')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <span>{{ Lang::get('main.medical_charge_transaction_suspend_log') }}</span>
            </li>
        </ul>
    ...
    <!-- END PAGE BAR -->
    <!-- BEGIN PAGE TITLE-->
    <h1 class="page-title"> {{ Lang::get('main.medical_charge_transaction_suspend_log') }}
...
<style>
    ...
    @if(PerUser('medical_charge_transaction_suspend_log_add'))
        <div class="row">
            <div class="col-md-12">
                <div class="btn-group pull-right">
                    <a href="{{ URL('admin/mctsl/create') }}" id="sample_editable_1_new" class="btn green">
    ...
    @endif
    @if(PerUser('medical_charge_transaction_suspend_log_view'))
        <div class="row">
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        <i class="icon-users font-dark"></i>
                        <span class="caption-subject bold uppercase">{{ Lang::get('main.medical_charge_transaction_suspend_log') }}</span>
                    </div>
                    <div class="tools"></div>
                </div>
...
@section('scriptCode')
    ...
    <script>
        $(document).ready(function () {
            ...
            {{--@if(PerUser('medical_charge_transaction_suspend_log_publish'))--}}
            ...
            grid.init({
                ...
                dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                    ...
                    "ajax": {
                        "url": "{{ URL('admin/mctsl_search') }}", // ajax source
                    },
            ...
            @if(PerUser('medical_charge_transaction_suspend_log_delete'))
            $(document).on('click', '.delete_this', function (event) {

                var deleted_id = $(this).attr("data-id");
                event.preventDefault();
                BootstrapDialog.show({
                    title: '{{ Lang::get('main.delete').lang::get('main.medical_charge_transaction_suspend_log') }}',
                    message: '{{ Lang::get('main.delete_this').lang::get('main.medical_charge_transaction_suspend_log') }} ?',
                    buttons: [
                        {
                            ...
                            action: function (dialogItself) {
                                $.ajax({
                                    type: "DELETE",
                                    url: "{{ URL('admin/mctsl') }}/" + deleted_id,
