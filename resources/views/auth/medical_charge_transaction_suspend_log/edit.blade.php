...
@section('contentHeader')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{ URL('/admin/mctsl') }}">{{ Lang::get('main.medical_charge_transaction_suspend_log') }}</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
    ...
    <div class="row">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                {!! Form::open(['method'=>'PUT','url'=>'admin/mctsl/'.$transaction->id,'class'=>"form-horizontal"]) !!}
                <div class="form-body">
        ...
        $(document).ready(function () {
            $('#user').keyup(function(){
                ...
                if(query!=''){
                    ...
                    $.ajax({
                        type: "POST",
                        url: "{{ URL('admin/mctsl/autoCompleteUsers') }}",
