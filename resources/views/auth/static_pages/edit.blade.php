            ...
            <div class="portlet-body">
                ...
                <div class="form-group col-lg-9">
                    ...
                    <div class="input-icon right">
                        <i class="fa"></i>
                        <input type="text" class="form-control" value="{{$static_page->name}}" id="name" name="name"
                               data-required="1"
                ...
                <div class="form-group col-lg-3 text-center" style="margin-top:25px;">
                    <input type="checkbox" class="make-switch" name="published" value="yes"
                           @if($static_page->published=="yes") checked @endif data-size="small" data-on-color="success"
                ...
                <div class="form-group col-lg-12">
                    ...
                    <div class="input-icon right">
                        <i class="fa"></i>
                        <input type="text" class="form-control" value="{{$static_page->link}}" id="link"
                               name="link" data-required="1" placeholder="{{ Lang::get('main.enter').Lang::get('main.link') }}">
                    </div>
                </div>
