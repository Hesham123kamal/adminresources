...
@section('contentHeader')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <span>{{ Lang::get('main.instructors') }}</span>
            </li>
        </ul>
...
@section('content')
    ...
    @if(PerUser('instructors_add'))
        <div class="row">
            <div class="col-md-12">
                <div class="btn-group pull-right">
                    <a href="{{ URL('admin/instructors/create') }}" id="sample_editable_1_new" class="btn green">
...
@section('scriptCode')
    ...
    <script>
        $(document).ready(function () {
            ...
            @if(PerUser('instructors_publish'))
            $(document).on('change','.changeStatues',function(){
                ...
                if(statues){
                    $.ajax({
                        type: "POST",
                        url: "{{ URL('admin/instructors/publish') }}",
            ...
            grid.init({
                ...
                onDataLoad: function (grid) {
                    ...
                    $edit_drug.editable({
                        ...
                        url: "{{ URL('admin/instructors') }}/" + $edit_drug_status_id + '/editinstructorstatus',
                ...
                dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                    ...
                    "ajax": {
                        "url": "{{ URL('admin/instructors_search') }}", // ajax source
                    },
            ...
            $(document).on('click', '.confirm_deletion', function (event) {
                ...
                $.ajax(
                    {
                        url: "{{ URL('admin/instructors') }}/" + drug_id,
            ...
            @if(PerUser('instructors_delete'))
            $(document).on('click', '.delete_this', function (event) {

                var deleted_id = $(this).attr("data-id");
                event.preventDefault();
                BootstrapDialog.show({
                    title: '{{ Lang::get('main.delete').lang::get('main.instructors') }}',
                    message: '{{ Lang::get('main.delete_this').lang::get('main.instructors') }} ?',
                    buttons: [
                        {
                            ...
                            action: function (dialogItself) {
                                $.ajax({
                                    type: "DELETE",
                                    url: "{{ URL('admin/instructors') }}/" + deleted_id,
