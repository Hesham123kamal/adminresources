    ...
    <div class="row">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                {!! Form::open(['method'=>'POST','url'=>'admin/instructors','id'=>'addInstructorsForm','files'=>true]) !!}
                <div class="form-body">
                    ...
                    <div class="form-group col-lg-6">
                        ...
                        <div class="input-icon right">
                            <i class="fa"></i>
                            <input type="text" class="form-control" value="" id="title" name="title" data-required="1" placeholder="{{ Lang::get('main.enter').Lang::get('main.title') }}">
                        </div>
                    </div>
                    <div class="form-group col-lg-6">
                        ...
                        <div class="input-icon right">
                            <i class="fa"></i>
                            <input type="text" class="form-control" value="" id="en_title" name="en_title" data-required="1" placeholder="{{ Lang::get('main.enter').Lang::get('main.en_title') }}">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12 form-group">
                        ...
                        <textarea class="form-control editor" name="en_description" id="en_description">{!! old('en_description') !!}</textarea>
                    </div>
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <div class="input-icon right">
                            <i class="fa"></i>
                            <input type="text" class="form-control" value="" id="linkedin" name="linkedin" data-required="1"
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <div class="input-icon right">
                            <i class="fa"></i>
                            <input type="text" class="form-control" value="" id="facebook" name="facebook" data-required="1"
