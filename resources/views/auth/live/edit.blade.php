    ...
    <div class="row">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                {!! Form::open(['method'=>'PUT','url'=>'admin/live/'.$live->id,'class'=>"form-horizontal",'files'=>true]) !!}
                <div class="form-body">
                ...
                <div class="form-group col-lg-12">
                    ...
                    <div class="input-icon right">
                        <i class="fa"></i>
                        <input type="text" class="form-control" value="{{$live->name}}" id="name" name="name" data-required="1"
                ...
                <div class="form-group col-lg-3 text-center" style="margin-top:25px;">
                    <input type="checkbox" class="make-switch" name="active" value="yes"
                           @if($live->published=="yes") checked @endif data-size="small" data-on-color="success"
                ...
                <div class="form-group col-lg-12">
                    ...
                    <div class="input-icon right">
                        <i class="fa"></i>
                        <input type="text" class="form-control" value="{{$live->short_description}} " id="short_description" name="short_description" data-required="1"
                               placeholder="{{ Lang::get('main.enter').Lang::get('main.short_description') }}">
                    </div>
                </div>

                @include('auth/description',['posts' =>[$live->description]])
                ...
                <div class="form-group col-lg-12">
                    ...
                    <div class="input-icon right">
                        <i class="fa"></i>
                        <input type="text" class="form-control" value="{{$live->link}}" id="v_url" name="v_url" data-required="1"
                ...
                {{--<div class="form-group col-lg-12">--}}
                    ...
                    {{--<div class="input-icon right">--}}
                        {{--<i class="fa"></i>--}}
                        {{--<input type="text" class="form-control" value="{{$live->audio_link}}" name="audio_link" data-required="1"--}}
                ...
                <div class="form-group col-lg-12">
                    ...
                    <div class="input-icon right">
                        <i class="fa"></i>
                        <img width="20%" src="{{assetURL($live->image) }}">
                    </div>
                </div>
                ...
                <div class="form-group col-lg-12">
                    ...
                    <div class="input-group date fromToDate margin-bottom-5" data-date-format="yyyy-mm-dd">
                        <input type="text" class="form-control form-filter input-sm" readonly value="{{$live->duetime}}"
                ...
                {{--<div class="form-group col-lg-12">--}}
                    ...
                    {{--<select name="instructors" class="module_name sel2 form-control form-filter"--}}
                        ...
                        {{--@foreach($instructors as $instructor)--}}
                            {{--<option @if($instructor->id==$live->instractor)  selected="selected" @endif value="{{$instructor->id}}">{{$instructor->name}}</option>--}}
                        {{--@endforeach--}}
                    {{--</select>--}}
                {{--</div>--}}
                ...
                <div class="form-group col-lg-12">
                    ...
                    <select name="location" class="module_name sel2 form-control form-filter"
                        ...
                        <option @if($live->location=='egy') selected="selected" @endif value="egy">EGP</option>
                        <option @if($live->location=='ksa') selected="selected" @endif value="ksa">KSA</option>
                    </select>
                </div>
                ...
                <div class="form-group col-lg-12">
                    ...
                    <div class="input-icon right">
                        <i class="fa"></i>
                        <input type="text" class="form-control" value="{{$live->url}}" id="url" name="url" data-required="1"
                               placeholder="{{ Lang::get('main.enter').Lang::get('main.url') }}">
                    </div>
                </div>
                ...
                {{--<div class="form-group col-lg-12">--}}
                    ...
                    {{--<select name="type" class="module_name sel2 form-control form-filter"--}}
                        ...
                        {{--<option @if($live->type=='online') selected="selected" @endif value="online">Online</option>--}}
                        {{--<option @if($live->type=='offline') selected="selected" @endif value="offline">Offline</option>--}}
                    {{--</select>--}}
                {{--</div>--}}
                ...
                {{--<div class="form-group col-lg-12">--}}
                    ...
                    {{--<select name="parent_id" class="module_name sel2 form-control form-filter" id="parent_id">--}}
                        ...
                        {{--@foreach($parent_lives as $parent_live)--}}
                            {{--<option @if($parent_live->id==$live->parent_id)  selected="selected" @endif value="{{$parent_live->id}}">{{$parent_live->name}}</option>--}}
                        {{--@endforeach--}}
                    {{--</select>--}}
                {{--</div>--}}
                ...
                <div class="form-group col-lg-12">
                    ...
                    <select name="isfree" class="module_name sel2 form-control form-filter"
                        ...
                        <option @if($live->isfree=='no') selected="selected" @endif value="no">no</option>
                        <option @if($live->isfree=='yes') selected="selected" @endif value="yes">yes</option>
                    </select>
                </div>
                ...
                <div class="form-group col-lg-12">
                    ...
                    <div class="input-icon right">
                        <i class="fa"></i>
                        <input type="text" class="form-control" value="{{$live->meta_description}} " id="meta_description" name="meta_description" data-required="1"
