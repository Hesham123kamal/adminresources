    ...
    <div class="row">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                {!! Form::open(['method'=>'PUT','url'=>'admin/courses_categories/'.$course_category->id,'class'=>"form-horizontal"]) !!}
                <div class="form-body">
                ...
                <div class="form-group col-lg-9">
                    ...
                    <select id="category" name="category" class="module_name form-control form-filter">
                        ...
                        @foreach($categories as $id=>$name)
                            <option @if($course_category->category_id==$id)  selected="selected"
                ...
                <div class="form-group col-lg-3 text-center" style="margin-top:25px;">
                    <input type="checkbox" class="make-switch" name="published" value="yes"
                           @if($course_category->published=="yes") checked @endif data-size="small" data-on-color="success"
                ...
                <div class="form-group col-lg-12">
                    ...
                    <select id="sub_category" name="sub_category" class="module_name form-control form-filter">
                        ...
                        @foreach($sub_categories as $id=>$name)
                            <option @if($course_category->sup_category_id==$id)  selected="selected"
                                    @endif value="{{$id}}">{{$name}}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="form-group col-lg-12">
                    ...
                    <select name="course" class="module_name form-control form-filter">
                        ...
                        @foreach($courses as $id=>$name)
                            <option @if($course_category->course_id==$id)  selected="selected"
                                    @endif value="{{$id}}">{{$name}}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group col-lg-12">
                    ...
                    <div class="input-icon right">
                        <i class="fa"></i>
                        <input type="text" class="form-control" value="{{$course_category->sort}}" name="sort" data-required="1"
