...
@section('contentHeader')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <span>{{ Lang::get('main.international_diplomas') }}</span>
            </li>
        </ul>
...
@section('content')
    ...
    @if(PerUser('international_diplomas_add'))
        <div class="row">
            <div class="col-md-12">
                <div class="btn-group pull-right">
                    <a href="{{ URL('admin/international_diplomas/create') }}" id="sample_editable_1_new" class="btn green">
    ...
    @endif
    @if(PerUser('international_diplomas_view'))
        <div class="row">
                ...
                <div class="portlet-body">
                    <table class="table table-striped table-bordered table-hover dt-responsive" width="100%"
                        ...
                        <tr role="row" class="heading">
                            ...
                            <th width="20%">{{ Lang::get('main.en_name') }}</th>
                            <th width="10%">{{ Lang::get('main.code') }}</th>
                            <th width="10%">{{ Lang::get('main.pic') }}</th>
                            <th width="10%">{{ Lang::get('main.url') }}</th>
                            <th width="10%">{{ Lang::get('main.created_time') }}</th>
                            <th width="10%">{{ Lang::get('main.all_category') }}</th>
                        ...
                        <tr role="row" class="filter">
                            ...
                            <td>
                                <input type="text" class="form-control form-filter input-sm" name="pic">
                            </td>
                            <td>
        ...
        $(document).ready(function () {
            ...
            grid.init({
                ...
                onDataLoad: function (grid) {
                    ...
                    {{--$edit_drug.editable({--}}
                        {{--source: [--}}
                            ...
                            {{--}--}}
                        {{--],--}}
                        {{--url: "{{ URL('admin/international_diplomas') }}/" + $edit_drug_status_id + '/editsuccessstoriestatus',--}}
                ...
                dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                    ...
                    "ajax": {
                        "url": "{{ URL('admin/international_diplomas_search') }}", // ajax source
                    },
            ...
            $(document).on('click', '.confirm_deletion', function (event) {
                ...
                $.ajax(
                    {
                        url: "{{ URL('admin/international_diplomas') }}/" + drug_id,
            ...
            @if(PerUser('international_diplomas_delete'))
            $(document).on('click', '.delete_this', function (event) {

                var deleted_id = $(this).attr("data-id");
                event.preventDefault();
                BootstrapDialog.show({
                    title: '{{ Lang::get('main.delete').lang::get('main.international_diplomas') }}',
                    message: '{{ Lang::get('main.delete_this').lang::get('main.international_diplomas') }} ?',
                    buttons: [
                        {
                            ...
                            action: function (dialogItself) {
                                $.ajax({
                                    type: "DELETE",
                                    url: "{{ URL('admin/international_diplomas') }}/" + deleted_id,
