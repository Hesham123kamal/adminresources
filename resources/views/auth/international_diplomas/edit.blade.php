...
@section('contentHeader')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <span>{{ $international_diploma->name }}</span>
            </li>
    ...
    <div class="row">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                {!! Form::open(['method'=>'PUT','url'=>'admin/international_diplomas/'.$international_diploma->id,'id'=>'addModulesForm','files'=>true]) !!}
                <div class="form-body">
                ...
                <div class="form-group col-lg-7">
                    ...
                    <div class="input-icon right">
                        <i class="fa"></i>
                        <input type="text" class="form-control" value="{{$international_diploma->name}}" id="name" name="name" data-required="1"
                ...
                <div class="form-group col-lg-2">
                    ...
                    <select id="direction" name="direction" class="form-control">
                        <option value="rtl" @if($international_diploma->direction == 'rtl') selected @endif>Arabic</option>
                        <option value="ltr" @if($international_diploma->direction == 'ltr') selected @endif>English</option>
                    </select>
                </div>
                <div class="form-group col-lg-3 text-center" style="margin-top:25px;">
                    <input type="checkbox" class="make-switch" name="active" value="yes" @if($international_diploma->published=="yes") checked @endif data-size="small" data-on-color="success" data-on-text="{{ Lang::get('main.active') }}" data-off-color="default" data-off-text="{{ Lang::get('main.inActive') }}">
                </div>
                <div class="form-group col-lg-12">
                    <label for="category">{{ Lang::get('main.all_category') }}</label>
                    <select name="category" class="module_name select2 form-control form-filter"
                            id="category">
                        <option value=" ">{{Lang::get('main.select')}}{{Lang::get('main.all_category')}}</option>
                        @foreach($categories as $category)
                            <option @if($category->id==$international_diploma->category_id)  selected="selected" @endif value="{{$category->id}}">{{$category->name}}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="form-group col-lg-12">
                    ...
                    <div class="input-icon right">
                        <i class="fa"></i>
                        <input type="text" class="form-control" value="{{$international_diploma->en_name}}" id="en_name" name="en_name" data-required="1"
                ...
                <div class="form-group col-lg-12">
                    ...
                    <div class="input-icon right">
                        <i class="fa"></i>
                        <input type="text" class="form-control" value="{{$international_diploma->code}}" id="code" name="code" data-required="1"
                ...
                <div class="form-group col-lg-12">
                    ...
                    <div class="input-icon right">
                        <i class="fa"></i>
                        <input type="number" min="0" class="form-control" value="{{$international_diploma->egy_price}}" id="egy_price" name="egy_price" data-required="1"
                ...
                <div class="form-group col-lg-12">
                    ...
                    <div class="input-icon right">
                        <i class="fa"></i>
                        <input type="number" min="0" class="form-control" value="{{$international_diploma->ksa_price}}" id="ksa_price" name="ksa_price" data-required="1"
                               placeholder="{{ Lang::get('main.enter').Lang::get('main.ksa_price') }}">
                    </div>
                </div>

                @include('auth/description',['posts' =>[$international_diploma->description]])

                <div class="form-group col-lg-12">
                    <label class="control-label">{{ Lang::get('main.pic')}}</label>
                    <div class="input-icon right">
                        <i class="fa"></i>
                        <img src="{{assetURL($international_diploma->image) }}">
                    </div>
                </div>
                ...
                <div class="form-group col-lg-12">
                    ...
                    <div class="input-icon right">
                        <i class="fa"></i>
                        <input type="text" class="form-control" value="{{$international_diploma->url}}" id="url" name="url" data-required="1"
                ...
                <div class="form-group col-lg-12">
                    ...
                    <select name="sent" class="module_name sel2 form-control form-filter"
                        ...
                        <option @if($international_diploma->sent=='yes') selected="selected" @endif value="yes">yes</option>
                        <option @if($international_diploma->sent=='no') selected="selected" @endif value="no">no</option>
                    </select>
                </div>
                ...
                <div class="form-group col-lg-12">
                    ...
                    <div class="input-icon right">
                        <i class="fa"></i>
                        <input type="text" class="form-control" value="{{$international_diploma->certificate_increment}}" id="certificate_increment" name="certificate_increment" data-required="1"
                ...
                <div class="form-group col-lg-12">
                    ...
                    <div class="input-icon right">
                        <i class="fa"></i>
                        <input type="number" min="0" class="form-control" value="{{$international_diploma->egy_sale_price}}" id="egy_sale_price" name="egy_sale_price" data-required="1"
                ...
                <div class="form-group col-lg-12">
                    ...
                    <div class="input-icon right">
                        <i class="fa"></i>
                        <input type="number" min="0" class="form-control" value="{{$international_diploma->ksa_sale_price}}" id="ksa_sale_price" name="ksa_sale_price" data-required="1"
                ...
                <div class="form-group col-lg-12">
                    ...
                    <div class="input-icon right">
                        <i class="fa"></i>
                        <input type="number" min="0" class="form-control" value="{{$international_diploma->tool_eg_price}}" id="tool_eg_price" name="tool_eg_price" data-required="1"
                ...
                <div class="form-group col-lg-12">
                    ...
                    <div class="input-icon right">
                        <i class="fa"></i>
                        <input type="number" min="0" class="form-control" value="{{$international_diploma->tool_ksa_price}}" id="tool_ksa_price" name="tool_ksa_price" data-required="1"
                ...
                <div class="form-group col-lg-12">
                    ...
                    <div class="input-icon right">
                        <i class="fa"></i>
                        <input type="number" min="0" class="form-control" value="{{$international_diploma->sort}}" id="sort" name="sort" data-required="1"
...
@section('scriptCode')
    <script>
        ...
        $(document).ready(function () {
            ...
            @if(PerUser('international_diplomas_active'))
