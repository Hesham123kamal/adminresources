...
@section('contentHeader')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{ URL('/admin/idct') }}">{{ Lang::get('main.international_diplomas_charge_transaction') }}</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
    ...
    <div class="row">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                {!! Form::open(['method'=>'PUT','url'=>'admin/idct/'.$transaction->id,'class'=>"form-horizontal",'files'=>true]) !!}
                <div class="form-body">
                ...
                <div class="form-group col-lg-12">
                    ...
                    <select name="diploma" class="module_name sel2 form-control form-filter">
                        ...
                        @foreach($diplomas as $id=>$name)
                            <option @if($transaction->diploma_id== $id) selected="selected" @endif value="{{$id}}">{{$name}}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group col-lg-12">
                    ...
                    <div class="input-icon right">
                        <i class="fa"></i>
                        <input type="text" class="form-control" value="{{$transaction->diploma_price}}" name="diploma_price" data-required="1"
                ...
                <div class="form-group col-lg-12">
                    ...
                    <div class="input-group date margin-bottom-5" data-date-format="yyyy-mm-dd">
                        <input type="text" value="{{$transaction->start_date}}" class="form-control form-filter input-sm start_date"
                ...
                <div class="form-group col-lg-12">
                    <label class="control-label" for="end_date">{{ Lang::get('main.end_date') }} <span
                                class="required"> * </span></label>
                    <div class="input-group date margin-bottom-5" data-date-format="yyyy-mm-dd">
                        <input type="text" value="{{$transaction->end_date}}" class="form-control form-filter input-sm end_date"
                ...
                <div class="form-group col-lg-12">
                    ...
                    <select name="subscribe_type" class="module_name sel2 form-control form-filter">
                        ...
                        <option @if($transaction->subscrip_type=='diploma_free') selected="selected" @endif value="diploma_free">diploma free</option>
                        <option @if($transaction->subscrip_type=='diploma_paid') selected="selected" @endif value="diploma_paid">diploma paid</option>
                        <option @if($transaction->subscrip_type=='diploma_onlinepayment') selected="selected" @endif value="diploma_onlinepayment">diploma online payment</option>
                    </select>
                </div>
                <div class="form-group col-lg-12">
                ...
                <div class="form-group col-lg-3 text-center" style="margin-top:25px;">
                    <input type="checkbox" class="make-switch" name="suspend" value="1" @if($transaction->suspend==1) checked @endif data-size="small"
                           data-on-color="success" data-on-text="{{ Lang::get('main.suspend') }}" data-off-color="default"
                           data-off-text="{{ Lang::get('main.unsuspend') }}">
                </div>
                <div class="form-group col-lg-3 text-center" style="margin-top:25px;">
        ...
        $(document).ready(function () {
            ...
            $('#user').keyup(function(){
                ...
                if(query!=''){
                    ...
                    $.ajax({
                        type: "POST",
                        url: "{{ URL('admin/idct/autoCompleteUsers') }}",
