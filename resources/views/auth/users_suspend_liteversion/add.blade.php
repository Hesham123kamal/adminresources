    ...
    <div class="row">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                {!! Form::open(['method'=>'POST','url'=>'admin/users_suspend_liteversion','class'=>"form-horizontal"]) !!}
                <div class="form-body">
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <select name="type" class="module_name sel2 form-control form-filter">
                            ...
                            <option @if(old('type')=='suspend') selected="selected" @endif value="suspend">{{ Lang::get('main.suspend') }}</option>
                            <option @if(old('type')=='unsuspend') selected="selected" @endif value="unsuspend">{{ Lang::get('main.unsuspend') }}</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <div class="input-group date margin-bottom-5" data-date-format="yyyy-mm-dd">
                            <input type="text" class="form-control form-filter input-sm date_field"
                                   name="suspendtime" placeholder="{{ Lang::get('main.enter').Lang::get('main.suspendtime') }}" value="{{old('start_date')}}">
