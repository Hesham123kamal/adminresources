    ...
    <div class="row">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                {!! Form::open(['method'=>'POST','url'=>'admin/diplomas_targets','class'=>"form-horizontal"]) !!}
                <div class="form-body">
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <div class="input-icon right">
                            <i class="fa"></i>
                            <input type="text" class="form-control" value=""  name="target" data-required="1"
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <div class="input-group date margin-bottom-5" data-date-format="yyyy-mm-dd">
                            <input type="text" class="form-control form-filter input-sm date"
                                   name="date" placeholder="{{ Lang::get('main.date') }}">
