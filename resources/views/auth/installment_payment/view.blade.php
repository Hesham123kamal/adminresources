...
@section('contentHeader')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <span>{{ Lang::get('main.installment_payment') }}</span>
            </li>
        </ul>
...
<style>
    ...
    @if(PerUser('installment_payment_add'))
        <div class="row">
            <div class="col-md-12">
                <div class="btn-group pull-right">
                    <a href="{{ URL('admin/installment_payment/create') }}" id="sample_editable_1_new" class="btn green">
    ...
    @endif
    @if(PerUser('installment_payment_view'))
        <div class="row">
...
@section('scriptCode')
    ...
    <script>
        $(document).ready(function () {
            ...
            {{--@if(PerUser('installment_payment_publish'))--}}
            {{--$(document).on('change', '.changeStatues', function () {--}}
                ...
                {{--if (statues) {--}}
                    {{--$.ajax({--}}
                        {{--type: "POST",--}}
                        {{--url: "{{ URL('admin/installment_payment/publish') }}",--}}
            ...
            grid.init({
                ...
                dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                    ...
                    "ajax": {
                        "url": "{{ URL('admin/installment_payment_search') }}", // ajax source
                    },
            ...
            @if(PerUser('installment_payment_delete'))
            $(document).on('click', '.delete_this', function (event) {
                var deleted_id = $(this).attr("data-id");
                event.preventDefault();
                BootstrapDialog.show({
                    title: '{{ Lang::get('main.delete').lang::get('main.installment_payment') }}',
                    message: '{{ Lang::get('main.delete_this').lang::get('main.installment_payment') }} ?',
                    buttons: [
                        {
                            ...
                            action: function (dialogItself) {
                                $.ajax({
                                    type: "DELETE",
                                    url: "{{ URL('admin/installment_payment') }}/" + deleted_id,
