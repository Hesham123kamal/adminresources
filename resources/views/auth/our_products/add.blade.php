    ...
    <div class="row">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                {!! Form::open(['method'=>'POST','url'=>'admin/our_products','id'=>'addour_productsForm','files'=>true]) !!}
                <div class="form-body">
                   ...
                   {{-- <script type="text/javascript" src="{{ asset('js/tinymce/tinymce.min.js') }}"></script>
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <div class="input-icon right">
                            <i class="fa"></i>
                            <input type="text" @if(!PerUser('our_products_url')) disabled="disabled" readonly="readonly" @endif class="form-control" id="url" value="{{ old('url') }}" name="url"  data-required="1" placeholder="{{ Lang::get('main.enter').Lang::get('main.url') }}">
                        </div>
                    </div>
                    <div class="form-group col-lg-12">
                    ...
                    <div class="text-center">
                        <div class="fileinput fileinput-new" data-provides="fileinput">
                            <div class="fileinput-new thumbnail" style="width: 200px; height: 150px; border: none">
                                <img src="{{ asset('img/our_products/default_image.png') }}" alt="" /> </div>
