...
@section('contentHeader')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <span>{{ Lang::get('main.medical_categories') }}</span>
            </li>
        </ul>
...
@section('content')
    ...
    @if(PerUser('medical_categories_add'))
        <div class="row">
            <div class="col-md-12">
                <div class="btn-group pull-right">
                    <a href="{{ URL('admin/medical_categories/create') }}" id="sample_editable_1_new" class="btn green">
    ...
    @endif
    @if(PerUser('medical_categories_view'))
        <div class="row">
...
@section('scriptCode')
    ...
    <script>
        $(document).ready(function () {
            ...
            @if(PerUser('medical_categories_publish'))
            $(document).on('change', '.changeStatues', function () {
                ...
                if (statues) {
                    $.ajax({
                        type: "POST",
                        url: "{{ URL('admin/medical_categories/publish') }}",
            ...
            grid.init({
                ...
                dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                    ...
                    "ajax": {
                        "url": "{{ URL('admin/medical_categories_search') }}", // ajax source
                    },
            ...
            {{--$(document).on('click', '.confirm_deletion', function (event) {--}}
                ...
                {{--$.ajax(--}}
                    {{--{--}}
                        {{--url: "{{ URL('admin/medical_categories') }}/" + drug_id,--}}
            ...
            {{--});--}}
            @if(PerUser('medical_categories_delete'))
                    ...
                    buttons: [
                        {
                            ...
                            action: function (dialogItself) {
                                $.ajax({
                                    type: "DELETE",
                                    url: "{{ URL('admin/medical_categories') }}/" + deleted_id,
