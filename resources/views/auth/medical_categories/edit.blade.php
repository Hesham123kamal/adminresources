    ...
    <div class="row">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                {!! Form::open(['method'=>'PUT','url'=>'admin/medical_categories/'.$medical_category->id,'class'=>"form-horizontal",'files'=>true]) !!}
                <div class="form-body">
                ...
                <div class="form-group col-lg-9">
                    ...
                    <select id="type" name="type" class="select2 form-control form-filter">
                        ...
                        <option value="main" @if($medical_category->parent_id==0) selected="selected" @endif>Main Category</option>
                        <option value="sub" @if($medical_category->parent_id!=0) selected="selected" @endif>Sub Category</option>
                    </select>
                </div>
                ...
                <div id="parent_category" class="form-group col-lg-12">
                    ...
                    <select name="parent_category" class="select2 form-control form-filter">
                        ...
                        @foreach($main_categories as $id=>$name)
                            @if($medical_category->id!=$id)
                            <option @if($medical_category->parent_id==$id) selected="selected" @endif value="{{$id}}">{{$name}}</option>
                            @endif
                            {{\App\Http\Controllers\Admin\MedicalCategoriesController::select_cat($id,$medical_category->parent_id,null,$medical_category->id)}}
                        @endforeach
                    </select>
                </div>
                ...
                <div class="form-group col-lg-12">
                    ...
                    <div class="input-icon right">
                        <i class="fa"></i>
                        <input type="text" class="form-control" value="{{$medical_category->meta_title}}" id="meta_title" name="meta_title" data-required="1"
                ...
                <div class="form-group col-lg-12">
                    ...
                    <div class="input-icon right">
                        <i class="fa"></i>
                        <input type="text" class="form-control" value="{{$medical_category->meta_description}}" id="meta_description" name="meta_description" data-required="1"
                ...
                <div class="form-group col-lg-12">
                    ...
                    <div class="input-icon right">
                        <i class="fa"></i>
                        <input type="text" class="form-control" value="{{$medical_category->meta_keywords}}" id="meta_keywords" name="meta_keywords" data-required="1"
...
@section('scriptCode')
    <script>
        $(document).ready(function () {
            ...
            @if($medical_category->parent_id==0)
