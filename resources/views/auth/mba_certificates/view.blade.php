...
@section('contentHeader')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <span>{{ Lang::get('main.mba_certificates') }}</span>
            </li>
        </ul>
...
<style>
    ...
    @if(PerUser('mba_certificates_add'))
        <div class="row">
            <div class="col-md-12">
                <div class="btn-group pull-right">
                    <a href="{{ URL('admin/mba_certificates/create') }}" id="sample_editable_1_new" class="btn green">
    ...
    @endif
    @if(PerUser('mba_certificates_view'))
        <div class="row">
        ...
        $(document).ready(function () {
            ...
            grid.init({
                ...
                dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                    ...
                    "ajax": {
                        "url": "{{ URL('admin/mba_certificates_search') }}", // ajax source
                    },
            ...
            @if(PerUser('mba_certificates_delete'))
            $(document).on('click', '.delete_this', function (event) {

                var deleted_id = $(this).attr("data-id");
                event.preventDefault();
                BootstrapDialog.show({
                    title: '{{ Lang::get('main.delete').lang::get('main.mba_certificate') }}',
                    message: '{{ Lang::get('main.delete_this').lang::get('main.mba_certificate') }} ?',
                    buttons: [
                        {
                            ...
                            action: function (dialogItself) {
                                $.ajax({
                                    type: "DELETE",
                                    url: "{{ URL('admin/mba_certificates') }}/" + deleted_id,
