<div class="question-container">
    ...
    <button class="btn btn-danger col-lg-offset-1 remove_question" data-type="chose_multiple" style="margin-top: 24px;height: 40px;
    ...
    @for($i = 0 ; $i < 4; $i++)
        <div class="form-group col-lg-6">
            ...
            <div class="input-group">
                ...
                @if($course_question->questions_type == 'arabic_and_english')
                    <input type="text" class="form-control" name="answers_text_en[]" placeholder="{{ Lang::get('main.enter').Lang::get('main.choice_en'). $i+1 }}">
                @endif
