...
@section('contentHeader')
    ...
    <h1 class="page-title"> {{ Lang::get('main.courses_questions') }}
        ...
        <button type="button" class="btn btn-primary pull-right" data-toggle="modal" data-target=".import-course-question-modal">Import Questions
        </button>
    </h1>
        ...
        <div class="modal-dialog modal-lg" style="margin-top: 50px;">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">{{ Lang::get('main.import') }}{{ Lang::get('main.questions') }}</h5>
                ...
                <div class="modal-body">
                    <div class="form-group form-group-select2">
                        ...
                        <select style="width: 100%" id="course_id" class="sel2" name="course_id">
                            <option value="" id="first_opt">{{ Lang::get('main.select') }}{{ Lang::get('main.course_name') }}</option>
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                <input type="text" class="form-control" id="searchQuestion" name="search_question"
                                       placeholder="{{ Lang::get('main.loading') }}">
                            </div>
                        </div>
                    </div>
                            ...
                            @foreach(old('questions')['name'] as $name)
                                @if(old('questions')['type'][$x]=='true_false')
                                    <div class="row">
                                        <div class="col-lg-10">
                                            ...
                                            <div class="form-group col-lg-3">
                                                <input type="file" style="width: 100%;margin-top: 30px;" name="image_e[{{ $x }}]">
                                            </div>
                                            <div class="col-lg-2" style="margin-top: 24px;">
                                                <div class="true">
                                                    ...
                                                    <label for="questions_answers_{{ $x }}_true"><span></span></label>
                                                </div>
                                                ...
                                                <div class="false">
                                                    ...
                                                    <label for="questions_answers_{{ $x }}_false"><span></span></label>
                                                </div>
                                            </div>
                                ...
                                @elseif(old('questions')['type'][$x]=='chose_single')
                                    <div>
                                        ...
                                        <div class="form-group col-lg-6">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-addon chose">
                                                    ...
                                                    <label for="chose_single_{{ $x }}_{{ $choseSingleCount }}_1"><span></span></label>
                                                </span>
                                                ...
                                                <span class="input-group-addon "><a href="#" class="removeAnswer"><i class="glyphicon glyphicon-trash"></i></a></span>
                                            </div>
                                        </div>

                                        <div class="form-group col-lg-6">
                                            <label for="chose_single_{{ $x }}_{{ $choseSingleCount }}_2">{{ Lang::get('main.choice_2') }}</label>
                                            <div class="input-group">
                                                <span class="input-group-addon chose">
                                                    ...
                                                    <label for="chose_single_{{ $x }}_{{ $choseSingleCount }}_2"><span></span></label>
                                                </span>
                                        ...
                                        <div class="form-group col-lg-6">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-addon chose">
                                                    ...
                                                    <label for="chose_single_{{ $x }}_{{ $choseSingleCount }}_3"><span></span></label>
                                                </span>
                                        ...
                                        <div class="form-group col-lg-6">
                                            <label for="chose_single_{{ $x }}_{{ $choseSingleCount }}_4">{{ Lang::get('main.choice_4') }}</label>
                                            <div class="input-group">
                                                <span class="input-group-addon chose">
                                                ...
                                                <label for="chose_single_{{ $x }}_{{ $choseSingleCount }}_4"><span></span></label></span>
                                ...
                                @elseif(old('questions')['type'][$x]=='chose_multiple')
                                    <div>
                                        ...
                                        <div class="form-group col-lg-6">
                                            <label for="chose_multiple_{{ $x }}_{{ $choseMultipleCount }}_1">{{ Lang::get('main.choice_1') }}</label>
                                            <div class="input-group">
                                                <span class="input-group-addon chose">
                                                    ...
                                                    <label for="chose_multiple_{{ $x }}_{{ $choseMultipleCount }}_1"><span></span></label>
                                                </span>
                                        ...
                                        <div class="form-group col-lg-6">
                                            <label for="chose_multiple_{{ $x }}_{{ $choseMultipleCount }}_2">{{ Lang::get('main.choice_2') }}</label>
                                            <div class="input-group">
                                            <span class="input-group-addon chose">
                                            ...
                                            <label for="chose_multiple_{{ $x }}_{{ $choseMultipleCount }}_2"><span></span></label>
                                            </span>
                                        ...
                                        <div class="form-group col-lg-6">
                                            <label for="chose_multiple_{{ $x }}_{{ $choseMultipleCount }}_3">Choice 3</label>
                                            <div class="input-group">
                                                <span class="input-group-addon chose">
                                                    ...
                                                    <label for="chose_multiple_{{ $x }}_{{ $choseMultipleCount }}_3"><span></span></label>
                                                </span>
                                        ...
                                        <div class="form-group col-lg-6">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-addon chose">
                                                    ...
                                                    <label for="chose_multiple_{{ $x }}_{{ $choseMultipleCount }}_4"><span></span></label>
                                                </span>
                                ...
                                @elseif(old('questions')['type'][$x]=='chose_single_with_images')
                                    <div>
                                        ...
                                        <div class="form-group col-lg-6">
                                            <label for="chose_single_with_images_{{ $x }}_{{ $choseSingleWithImagesCount }}_1">{{ Lang::get('main.choice_1') }}</label>
                                            <div class="input-group">
                                                    <span class="input-group-addon chose">
                                                        ...
                                                        <label for="chose_single_with_images_{{ $x }}_{{ $choseSingleWithImagesCount }}_1"><span></span></label>
                                                    </span>
                                        ...
                                        <div class="form-group col-lg-6">
                                            <label for="chose_single_with_images_{{ $x }}_{{ $choseSingleWithImagesCount }}_2">{{ Lang::get('main.choice_2') }}</label>
                                            <div class="input-group">
                                                    <span class="input-group-addon chose">
                                                        ...
                                                        <label for="chose_single_with_images_{{ $x }}_{{ $choseSingleWithImagesCount }}_2"><span></span></label>
                                                    </span>
                                                @if(isset(old('questions')['images_answers'][$x]))
                                        ...
                                        <div class="form-group col-lg-6">
                                            <label for="chose_single_with_images_{{ $x }}_{{ $choseSingleWithImagesCount }}_3">Choice 3</label>
                                            <div class="input-group">
                                                <span class="input-group-addon chose">
                                                    ...
                                                    <label for="chose_single_with_images_{{ $x }}_{{ $choseSingleWithImagesCount }}_3"><span></span></label>
                                                </span>
                                                @if(isset(old('questions')['images_answers'][$x]))
                                        ...
                                        <div class="form-group col-lg-6">
                                            <label for="chose_single_with_images_{{ $x }}_{{ $choseSingleWithImagesCount }}_4">{{ Lang::get('main.choice_4') }}</label>
                                            <div class="input-group">
                                            <span class="input-group-addon chose">
                                                ...
                                                <label for="chose_single_with_images_{{ $x }}_{{ $choseSingleWithImagesCount }}_4"><span></span></label>
                                            </span>
                                                @if(isset(old('questions')['images_answers'][$x]))
                                ...
                                @elseif(old('questions')['type'][$x]=='chose_multiple_with_images')
                                    <div>
                                        ...
                                        <div class="form-group col-lg-6">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-addon chose">
                                                    ...
                                                    <label for="chose_multiple_with_images_{{ $x }}_{{ $choseMultipleWithImagesCount }}_1"><span></span></label>
                                                </span>
                                                @if(isset(old('questions')['images_answers'][$x]))
                                                    <img style="width:150px;" src="{{assetURL(old('questions')['images_answers'][$x][0]) }}">
                                        ...
                                        <div class="form-group col-lg-6">
                                            <label for="chose_multiple_with_images_{{ $x }}_{{ $choseMultipleWithImagesCount }}_2">{{ Lang::get('main.choice_2') }}</label>
                                            <div class="input-group">
                                            <span class="input-group-addon chose">
                                                ...
                                                <label for="chose_multiple_with_images_{{ $x }}_{{ $choseMultipleWithImagesCount }}_2"><span></span></label>
                                            </span>
                                                @if(isset(old('questions')['images_answers'][$x]))
                                                    <img style="width:150px;" src="{{assetURL(old('questions')['images_answers'][$x][1]) }}">
                                        ...
                                        <div class="form-group col-lg-6">
                                            <label for="chose_multiple_with_images_{{ $x }}_{{ $choseMultipleWithImagesCount }}_3">Choice 3</label>
                                            <div class="input-group">
                                            <span class="input-group-addon chose">
                                                ...
                                                <label for="chose_multiple_with_images_{{ $x }}_{{ $choseMultipleWithImagesCount }}_3"><span></span></label>
                                            </span>
                                                @if(isset(old('questions')['images_answers'][$x]))
                                                    <img style="width:150px;" src="{{assetURL(old('questions')['images_answers'][$x][2]) }}">
                                        ...
                                        <div class="form-group col-lg-6">
                                            ...
                                            <span class="input-group-addon chose">
                                                ...
                                                <label for="chose_multiple_with_images_{{ $x }}_{{ $choseMultipleWithImagesCount }}_4"><span></span></label>
                                            </span>
                                                @if(isset(old('questions')['images_answers'][$x]))
                                                    <img style="width:150px;" src="{{assetURL(old('questions')['images_answers'][$x][3]) }}">
