...
@section('contentHeader')
    ...
    <!-- END PAGE BAR -->
    <!-- BEGIN PAGE TITLE-->
    <h1 class="page-title"> {{ Lang::get('main.abuse') }}
...
<style>
    ...
    @if(PerUser('abuse_view'))
        <div class="row">
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        <i class="icon-users font-dark"></i>
                        <span class=" bold">{{ Lang::get('main.abuse_title') }}</span>
                    </div>
                    <div class="tools"></div>
                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="input-group date margin-bottom-5">
                                            <input type="text" class="form-control form-filter input-sm fromToDate"
                                                   name="date_from" placeholder="{{ Lang::get('main.date_from') }}" data-date-format="yyyy-mm-dd">
                                            ...
                                            <input type="text" class="form-control form-filter input-sm fromToDate"
                                                   name="date_to" placeholder="{{ Lang::get('main.date_to') }}" data-date-format="yyyy-mm-dd">
                                            <span class="input-group-btn">
                                                    <button class="btn btn-sm default" type="button">
                                                        <i class="fa fa-calendar"></i>
                                                    </button>
        ...
        $(document).ready(function () {
            ...
            grid.init({
                ...
                dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                    ...
                    "ajax": {
                        "url": "{{ URL('admin/abuse_search') }}", // ajax source
                    },
