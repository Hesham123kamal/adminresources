...
@section('contentHeader')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <span>{{ Lang::get('main.our_partner_flags_flags') }}</span>
            </li>
        </ul>
    ...
    <!-- END PAGE BAR -->
    <!-- BEGIN PAGE TITLE-->
    <h1 class="page-title"> {{ Lang::get('main.our_partner_flags_flags') }}
...
@section('content')
    ...
    @if(PerUser('our_partner_flags_add'))
        <div class="row">
            <div class="col-md-12">
                <div class="btn-group pull-right">
                    <a href="{{ URL('admin/our_partner_flags/create') }}" id="sample_editable_1_new" class="btn green">
                        {{ Lang::get('main.add') }}
    ...
    @endif
    @if(PerUser('our_partner_flags_view'))
        <div class="row">
                ...
                <div class="portlet-body">
                    <table class="table table-striped table-bordered table-hover dt-responsive" width="100%"
                        ...
                        <tr role="row" class="heading">
                            ...
                            <th width="40%">{{ Lang::get('main.image') }}</th>
...
@section('scriptCode')
    ...
    <script>
        $(document).ready(function () {
            ...
            @if(PerUser('our_partner_flags_publish'))
            $(document).on('change', '.changeStatues', function () {
                ...
                if (statues) {
                    $.ajax({
                        type: "POST",
                        url: "{{ URL('admin/our_partner_flags/publish') }}",
            ...
            grid.init({
                ...
                dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                    ...
                    "ajax": {
                        "url": "{{ URL('admin/our_partner_flags_search') }}", // ajax source
                    },
            ...
            @if(PerUser('our_partner_flags_delete'))
            $(document).on('click', '.delete_this', function (event) {

                var deleted_id = $(this).attr("data-id");
                event.preventDefault();
                BootstrapDialog.show({
                    title: '{{ Lang::get('main.delete').lang::get('main.our_partner_flags') }}',
                    message: '{{ Lang::get('main.delete_this').lang::get('main.our_partner_flags') }} ?',
                    buttons: [
                        {
                            ...
                            action: function (dialogItself) {
                                $.ajax({
                                    type: "DELETE",
                                    url: "{{ URL('admin/our_partner_flags') }}/" + deleted_id,
