...
@section('contentHeader')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <span>{{ Lang::get('main.modules') }}</span>
            </li>
        </ul>
...
@section('content')
    ...
    @if(PerUser('modules_add'))
        <div class="row">
            <div class="col-md-12">
                <div class="btn-group pull-right">
                    <a href="{{ URL('admin/modules/create') }}" id="sample_editable_1_new" class="btn green">
                ...
                <div class="portlet-body">
                    <table class="table table-striped table-bordered table-hover dt-responsive" width="100%"
                        ...
                        <tr role="row" class="heading">
                            ...
                            <th width="10%">{{ Lang::get('main.questions_numbers') }}</th>
                        ...
                        <tr role="row" class="filter">
                            ...
                            <td>
                                <input type="number" min="0" class="form-control form-filter input-sm" name="questions_numbers">
                            </td>
                            <td>
        ...
        $(document).ready(function () {
            ...
            grid.init({
                ...
                onDataLoad: function (grid) {
                    ...
                    {{--$edit_drug.editable({--}}
                        {{--source: [--}}
                            ...
                            {{--}--}}
                        {{--],--}}
                        {{--url: "{{ URL('admin/modules') }}/" + $edit_drug_status_id + '/editsuccessstoriestatus',--}}
                ...
                dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                    ...
                    "ajax": {
                        "url": "{{ URL('admin/modules_search') }}", // ajax source
                    },
            ...
            @if(PerUser('modules_delete'))
            $(document).on('click', '.delete_this', function (event) {

                var deleted_id = $(this).attr("data-id");
                event.preventDefault();
                BootstrapDialog.show({
                    title: '{{ Lang::get('main.delete').lang::get('main.modules') }}',
                    message: '{{ Lang::get('main.delete_this').lang::get('main.modules') }} ?',
                    buttons: [
                        {
                            ...
                            action: function (dialogItself) {
                                $.ajax({
                                    type: "DELETE",
                                    url: "{{ URL('admin/modules') }}/" + deleted_id,
