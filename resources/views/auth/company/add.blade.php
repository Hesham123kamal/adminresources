...
@section('contentHeader')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{ URL('/admin/company') }}">{{ Lang::get('main.companies') }}</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption font-dark">
                    ...
                    <span class="caption-subject bold uppercase">{{ Lang::get('main.companies') }}</span>
                </div>
                <div class="tools"></div>
            </div>
            <div class="portlet-body">
                {!! Form::open(['method'=>'POST','url'=>'admin/company','class'=>"form-horizontal"]) !!}
                <div class="form-body">
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <div class="input-icon right">
                            <i class="fa"></i>
                            <input type="text" class="form-control" value="" id="name" name="employees_numbers" data-required="1"
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <div class="input-icon right">
                            <i class="fa"></i>
                            <input type="text" class="form-control" value="" id="amount" name="amount" data-required="1"
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <div class="input-icon right">
                            <i class="fa"></i>
                            <input type="text" class="form-control" value="" id="period" name="period" data-required="1"
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <div class="input-group date margin-bottom-5" data-date-format="yyyy-mm-dd">
                            <input type="text" class="form-control form-filter input-sm expiredDate"
                    ...
                    <div class="form-group col-lg-3 text-center" style="margin-top:25px;">
                        <input type="checkbox" class="make-switch" name="isfree" value="1" checked data-size="small"
                               data-on-color="success" data-on-text="{{ Lang::get('main.free') }}" data-off-color="default"
                               data-off-text="{{ Lang::get('main.notfree') }}">
                    </div>

                    @include('auth/description',['selectors'=>'.address,.description', 'labels'=>[Lang::get('main.address'),Lang::get('main.description')] ])
