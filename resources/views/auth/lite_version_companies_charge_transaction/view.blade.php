...
@section('contentHeader')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <span>{{ Lang::get('main.lite_version_companies_charge_transaction') }}</span>
            </li>
        </ul>
    ...
    <!-- END PAGE BAR -->
    <!-- BEGIN PAGE TITLE-->
    <h1 class="page-title"> {{ Lang::get('main.lite_version_companies_charge_transaction') }}
...
<style>
    ...
    @if(PerUser('lite_version_companies_charge_transaction_view'))
        <div class="row">
            <div id="errors"></div>
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase">{{ Lang::get('main.lite_version_companies_charge_transaction') }}</span>
                    </div>
                    <div class="tools"></div>
                </div>
...
@section('scriptCode')
    ...
    <script>
        $(document).ready(function () {
            ...
            {{--@if(PerUser('lite_version_companies_charge_transaction_publish'))--}}
            ...
            grid.init({
                ...
                dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                    ...
                    "ajax": {
                        "url": "{{ URL('admin/lcct_search') }}", // ajax source
                    },
            ...
            @if(PerUser('lite_version_companies_charge_transaction_delete'))
            $(document).on('click', '.delete_this', function (event) {

                var deleted_id = $(this).attr("data-id");
                event.preventDefault();
                BootstrapDialog.show({
                    title: '{{ Lang::get('main.delete').lang::get('main.lite_version_companies_charge_transaction') }}',
                    message: '{{ Lang::get('main.delete_this').lang::get('main.lite_version_companies_charge_transaction') }} ?',
                    buttons: [
                        {
