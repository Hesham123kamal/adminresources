        ...
        <div class="row">
            <div class="col-md-12">
                <div class="btn-group pull-right">
                    <a href="{{ URL('admin/tags/create') }}" id="sample_editable_1_new" class="btn green">
        ...
        $(document).ready(function () {
            ...
            grid.init({
                ...
                dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                    ...
                    "ajax": {
                        "url": "{{ URL('admin/tags_search') }}", // ajax source
                    },
            ...
            @if(PerUser('tags_delete'))
            $(document).on('click', '.delete_this', function (event) {

                var deleted_id = $(this).attr("data-id");
                event.preventDefault();
                BootstrapDialog.show({
                    title: '{{ Lang::get('main.delete').lang::get('main.tag') }}',
                    message: '{{ Lang::get('main.delete_this').lang::get('main.tag') }} ?',
                    buttons: [
                        {
