...
@section('contentHeader')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{ URL('/admin/session_successtories_views') }}">{{ Lang::get('main.session_successtories_views') }}</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
    ...
    <div class="row">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                {!! Form::open(['method'=>'POST','url'=>'admin/session_successtories_views','class'=>"form-horizontal"]) !!}
                <div class="form-body">
        ...
        $(document).ready(function () {
            $('#user').keyup(function(){
                ...
                if(query!=''){
                    ...
                    $.ajax({
                        type: "POST",
                        url: "{{ URL('admin/session_successtories_views/autoCompleteUsers') }}",
