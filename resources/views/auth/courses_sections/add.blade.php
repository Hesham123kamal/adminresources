...
@section('contentHeader')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{ URL('/admin/gallery') }}">{{ Lang::get('main.course_section') }}</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
    ...
    <div class="row">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                {!! Form::open(['method'=>'POST','url'=>'admin/courses_sections','class'=>"form-horizontal",'files'=>true]) !!}
                <div class="form-body">
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <select name="type" class="module_name sel2 form-control form-filter">
                            ...
                            <option @if(old('type')=='exam') selected="selected" @endif value="exam">{{ Lang::get('main.exam') }}</option>
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <div class="input-icon right">
                            <i class="fa"></i>
                            <input type="number" min="1" class="form-control" value="@if(old('sort')){{ old('sort') }}@else{{ $maxsort }}@endif" id="sort" name="sort" data-required="1"
