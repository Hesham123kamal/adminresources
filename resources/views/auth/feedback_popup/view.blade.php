...
@section('contentHeader')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <span>{{ Lang::get('main.feedback') }}</span>
            </li>
        </ul>
    </div>
    <!-- END PAGE BAR -->
                ...
                <div class="portlet-body">
                    <table style=" table-layout: fixed;width: 100%;" class="table table-striped table-bordered table-hover table-checkable" width="100%"
                        ...
                        <tr role="row" class="heading">
                            ...
                            <th width="15%">{{ Lang::get('main.feedback') }}</th>
                            <th>{{ Lang::get('main.page') }}</th>
                            <th width="15%">{{ Lang::get('main.answer') }}</th>
                            <th width="8%">{{ Lang::get('main.answered') }}</th>
                            <th width="8%">{{ Lang::get('main.displayed') }}</th>
                        ...
                        <tr role="row" class="filter">
                            ...
                            <td>
                                <input type="text" class="form-control form-filter input-sm" name="feedback">
                            </td>
                            <td>
                            ...
                            <td>
                                <select name="answered" class="form-control form-filter" id="answered">
                            ...
                            <td>
                                <select name="displayed" class="form-control form-filter" id="displayed">
                                    {{--<option value=" ">Select displayed status</option>--}}
                                    <option value="0" selected>0</option>
                                    <option value="1">1</option>
                                </select>
                            </td>
        ...
        $(document).ready(function () {
            ...
            grid.init({
                ...
                dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                    ...
                    "ajax": {
                        "url": "{{ URL('admin/feedback_search') }}", // ajax source
                    },
