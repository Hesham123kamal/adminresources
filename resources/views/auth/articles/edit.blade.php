...
@section('contentHeader')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{ URL('/admin/articles') }}">{{ Lang::get('main.articles') }}</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
    ...
    <div class="row">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                {!! Form::open(['method'=>'PUT','url'=>'admin/articles/'.$article->id,'id'=>'addArticlesForm','class'=>"form-horizontal",'files'=>true]) !!}
                <div class="form-body">
                ...
                <div class="form-group col-lg-6">
                    <label for="category">{{ Lang::get('main.category') }}</label>
                    <select name="category" class="module_name select2 form-control form-filter"
                            id="category">
                        <option value=" ">{{Lang::get('main.select')}}{{Lang::get('main.category')}}</option>
                        @foreach($categories as $category)
                            <option @if($category->id==$article->category_id)  selected="selected" @endif value="{{$category->id}}">{{$category->name}}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group col-lg-6">
