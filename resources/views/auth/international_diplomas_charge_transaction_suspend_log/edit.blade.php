...
@section('contentHeader')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{ URL('/admin/idctsl') }}">{{ Lang::get('main.international_diplomas_charge_transaction_suspend_log') }}</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
    ...
    <div class="row">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                {!! Form::open(['method'=>'PUT','url'=>'admin/idctsl/'.$transaction->id,'class'=>"form-horizontal"]) !!}
                <div class="form-body">
                ...
                <div class="form-group col-lg-9">
                    ...
                    <select name="transaction_id" class="module_name sel2 form-control form-filter">
                        ...
                        @foreach($transactions_ids as $i=>$d)
                            <option @if($transaction->transaction_id== $i) selected="selected" @endif value="{{$i}}">{{$d}}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group col-lg-3 text-center" style="margin-top:25px;">
        ...
        $(document).ready(function () {
            $('#user').keyup(function(){
                ...
                if(query!=''){
                    ...
                    $.ajax({
                        type: "POST",
                        url: "{{ URL('admin/idctsl/autoCompleteUsers') }}",
