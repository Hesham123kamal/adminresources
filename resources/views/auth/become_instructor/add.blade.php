    ...
    <div class="row">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                {!! Form::open(['method'=>'POST','url'=>'admin/become_instructor','class'=>"form-horizontal",'files'=>true]) !!}
                <div class="form-body">
                    <div id="message">
                    </div>
                    ...
                    @include('auth/description',['selectors'=>'.bio','labels'=>[Lang::get('main.bio')]])
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <div class="input-icon right">
                            <i class="fa"></i>
                            <input type="file" class="form-control" value="" id="cv" name="cv" data-required="1"
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <div class="input-icon right">
                            <i class="fa"></i>
                            <input type="text" class="form-control" value="" id="video" name="video" data-required="1"
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <textarea class="form-control" style="min-height: 300px;"
                                  ...
                                  placeholder="{{ Lang::get('main.enter').Lang::get('main.courses') }}"></textarea>
                    </div>
