<li class="question_body col-md-12" style="padding: 0;" data-id="{{$question->id}}">
    ...
    <div class="col-md-2 text-center" style="padding:0;">
        <div class="true">
            <input type="radio" name="answers_{{ $question->id }}" @if($question->ModulesTrainingsQuestionsDetails->answer == 1) checked="checked" @endif value="1" id="answers_{{ $question->id }}_true" disabled>
            <label for="answers_{{ $question->id }}_true">
                <span></span>
            </label>
        </div>
        <div class="false">
            <input type="radio" name="answers_{{ $question->id }}" @if($question->ModulesTrainingsQuestionsDetails->answer == 0) checked="checked" @endif value="0" id="answers_{{ $question->id }}_false" disabled>
