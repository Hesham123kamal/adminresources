<li class="question_body col-md-12" style="padding: 0;" data-id="{{$question->id}}">
    ...
    <div class="col-md-2 col-md-offset-2 row" style="padding: 0;">
        <button class="btn btn-success col-md-6 edit_question" data-type="chose_multiple" style="border-radius: 8px 0 0 8px !important;">
            <i class="glyphicon glyphicon-edit"></i>
        </button>
        <button class="btn btn-danger col-md-6 remove_question" data-type="chose_multiple" style="border-radius: 0 8px 8px 0 !important;">
            <i class="glyphicon glyphicon-trash"></i>
        </button>
    </div>
    <div class="col-md-12" style="margin: 0;padding: 0;">
    @foreach($question->ModulesTrainingsQuestionsDetails as $key => $detail)
        <div class="form-group col-lg-6">
            <div class="input-group">
                <span class="input-group-addon chose">
                    <input type="checkbox" class="choices_values" id="chose_multiple_{{ $detail->id }}" @if($detail->answer) checked="checked" @endif value="{{ $detail->id }}" name="chose_multiple[{{ $detail->id }}]" disabled>
                    <label for="chose_multiple_{{ $detail->id }}"><span></span></label>
                </span>
