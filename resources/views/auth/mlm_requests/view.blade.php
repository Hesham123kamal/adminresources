...
@section('contentHeader')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <span>{{ Lang::get('main.mlm_requests') }}</span>
            </li>
        </ul>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="btn-group pull-right">
                <a href="{{ URL('admin/mlm_requests/show') }}" id="sample_editable_1_new" class="btn green">
                    {{ Lang::get('main.make_request') }}
                </a>
            </div>
        </div>
    </div>
@endif
    @if(PerUser('mlm_requests_view'))
        <div class="row">
                ...
                <div class="portlet-body">
                    <table style=" table-layout: fixed;width: 100%;" class="table table-striped table-bordered table-hover table-checkable" width="100%"
                        ...
                        <tr role="row" class="heading">
                            ...
                            <th>{{ Lang::get('main.ip') }}</th>
                            <th width="20%">{{ Lang::get('main.data') }}</th>
                            <th>{{ Lang::get('main.url') }}</th>
                            <th width="15%">{{ Lang::get('main.response') }}</th>
                        ...
                        <tr role="row" class="filter">
                            ...
                            <td>
                                <input type="text" class="form-control form-filter input-sm" name="data_string">
                            </td>
                            <td>
                                <input type="text" class="form-control form-filter input-sm" name="url">
                            </td>
                            <td>
                                <input type="text" class="form-control form-filter input-sm" name="response">
                            </td>
                            <td>
        ...
        $(document).ready(function () {
            ...
            grid.init({
                ...
                dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                    ...
                    "ajax": {
                        "url": "{{ URL('admin/mlm_requests_search') }}", // ajax source
                    },
