    ...
    <div class="row">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                {!! Form::open(['method'=>'PUT','url'=>'admin/dcct/'.$transaction->id,'class'=>"form-horizontal",'files'=>true]) !!}
                <div class="form-body">
                ...
                <div class="form-group col-lg-12">
                    ...
                    <select name="company" class="module_name sel2 form-control form-filter">
                        ...
                        @foreach($companies as $id=>$name)
                            <option @if($transaction->company_id== $id) selected="selected" @endif value="{{$id}}">{{$name}}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group col-lg-12">
