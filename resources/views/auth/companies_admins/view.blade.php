...
@section('contentHeader')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <span>{{ Lang::get('main.companies_admins') }}</span>
            </li>
        </ul>
...
@if(PerUser('companies_admins_add'))
    <div class="row">
        <div class="col-md-12">
            <div class="btn-group pull-right">
                <a href="{{ URL('admin/companies_admins/create') }}" id="sample_editable_1_new" class="btn green">
...
@endif
    @if(PerUser('companies_admins_view'))
        <div class="row">
        ...
        $(document).ready(function () {
            ...
            grid.init({
                ...
                dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                    ...
                    "ajax": {
                        "url": "{{ URL('admin/companies_admins_search') }}", // ajax source
                    },
            ...
            @if(PerUser('companies_admins_delete'))
            $(document).on('click', '.delete_this', function (event) {

                var deleted_id = $(this).attr("data-id");
                event.preventDefault();
                BootstrapDialog.show({
                    title: '{{ Lang::get('main.delete').lang::get('main.company_admin') }}',
                    message: '{{ Lang::get('main.delete_this').lang::get('main.company_admin') }} ?',
                    buttons: [
                        {
                            ...
                            action: function (dialogItself) {
                                $.ajax({
                                    type: "DELETE",
                                    url: "{{ URL('admin/companies_admins') }}/" + deleted_id,
