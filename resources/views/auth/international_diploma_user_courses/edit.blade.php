...
@section('contentHeader')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{ URL('/admin/international_diploma_user_courses') }}">{{ Lang::get('main.international_diploma_user_courses') }}</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
    ...
    <div class="row">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                {!! Form::open(['method'=>'PUT','url'=>'admin/international_diploma_user_courses/'.$diploma_user_course->id,'class'=>"form-horizontal"]) !!}
                <div class="form-body">
        ...
        $(document).ready(function () {
            ...
            $('#user').keyup(function(){
                ...
                if(query!=''){
                    ...
                    $.ajax({
                        type: "POST",
                        url: "{{ URL('admin/international_diploma_user_courses/autoCompleteUsers') }}",
