...
@section('contentHeader')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <span>{{ Lang::get('main.initiative_videos') }}</span>
            </li>
        </ul>
...
@section('content')
    ...
    @if(PerUser('initiative_videos_add'))
        <div class="row">
            <div class="col-md-12">
                <div class="btn-group pull-right">
                    <a href="{{ URL('admin/initiative_videos/create') }}" id="sample_editable_1_new" class="btn green">
    ...
    @endif
    @if(PerUser('initiative_videos_view'))
        <div class="row">
                ...
                <div class="portlet-body">
                    <table class="table table-striped table-bordered table-hover dt-responsive" width="100%"
                        ...
                        <tr role="row" class="heading">
                            ...
                            <th>{{ Lang::get('main.title') }}</th>
                            <th>{{ Lang::get('main.link') }}</th>
                            <th>{{ Lang::get('main.section') }}</th>
                        ...
                        <tr role="row" class="filter">
                            ...
                            <td>
                                <input type="text" class="form-control form-filter input-sm" name="link">
                            </td>
                            <td>
...
@section('scriptCode')
    ...
    <script>
        $(document).ready(function () {
            ...
            @if(PerUser('initiative_videos_publish'))
            $(document).on('change', '.changeStatues', function () {
                ...
                if (statues) {
                    $.ajax({
                        type: "POST",
                        url: "{{ URL('admin/initiative_videos/publish') }}",
            ...
            grid.init({
                ...
                onDataLoad: function (grid) {
                    ...
                    {{--$edit_drug.editable({--}}
                        {{--source: [--}}
                            ...
                            {{--}--}}
                        {{--],--}}
                        {{--url: "{{ URL('admin/initiative_videos') }}/" + $edit_drug_status_id + '/editsuccessstoriestatus',--}}
                ...
                dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                    ...
                    "ajax": {
                        "url": "{{ URL('admin/initiative_videos_search') }}", // ajax source
                    },
                    "columnDefs": [{
            ...
            $(document).on('click', '.confirm_deletion', function (event) {
                ...
                $.ajax(
                    {
                        url: "{{ URL('admin/initiative_videos') }}/" + drug_id,
            ...
            @if(PerUser('initiative_videos_delete'))
            $(document).on('click', '.delete_this', function (event) {

                var deleted_id = $(this).attr("data-id");
                event.preventDefault();
                BootstrapDialog.show({
                    title: '{{ Lang::get('main.delete').lang::get('main.initiative_video') }}',
                    message: '{{ Lang::get('main.delete_this').lang::get('main.initiative_video') }} ?',
                    buttons: [
                        {
                            ...
                            action: function (dialogItself) {
                                $.ajax({
                                    type: "DELETE",
                                    url: "{{ URL('admin/initiative_videos') }}/" + deleted_id,
