...
@section('contentHeader')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{ URL('/admin/diplomas_courses_user_plan') }}">{{ Lang::get('main.diplomas_courses_user_plan') }}</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
    ...
    <div class="row">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                {!! Form::open(['method'=>'PUT','url'=>'admin/diplomas_courses_user_plan/'.$diplomas_courses_user_plan->id,'class'=>"form-horizontal"]) !!}
                <div class="form-body">
                ...
                <div class="form-group col-lg-12">
                    ...
                    <select name="exam" class="module_name sel2 form-control form-filter">
                        ...
                        <option @if($diplomas_courses_user_plan->exam=='not exam') selected="selected" @endif value="not exam">not exam</option>
                        <option @if($diplomas_courses_user_plan->exam=='pass') selected="selected" @endif value="pass">pass</option>
                        <option @if($diplomas_courses_user_plan->exam=='fail') selected="selected" @endif value="fail">fail</option>
                    </select>
                </div>

                {{--<div class="form-group col-lg-3 text-center" style="margin-top:25px;">--}}
                    {{--<input @if($diplomas_courses_user_plan->published=="yes") checked @endif type="checkbox" class="make-switch" name="published" data-size="small"--}}
                ...
                <div class="form-group col-lg-12">
                    ...
                    <select name="diploma" class="module_name sel2 form-control form-filter">
                        ...
                        @foreach($diplomas as $id=>$name)
                            <option @if($diplomas_courses_user_plan->diploma_id==$id) selected="selected" @endif value="{{$id}}">{{$name}}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="form-group col-lg-12">
                    ...
                    <select name="course" class="sel2 form-control form-filter">
                        ...
                        @foreach($courses as  $id=>$name)
                            <option @if($diplomas_courses_user_plan->course_id==$id) selected="selected" @endif value="{{$id}}">{{$name}}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="form-group col-lg-12">
                    ...
                    <div class="input-icon right">
                        <i class="fa"></i>
                        <input type="text" class="form-control" value="{{$diplomas_courses_user_plan->sort}}" name="sort" data-required="1"
