...
@section('contentHeader')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{ URL('/admin/modules_courses') }}">{{ Lang::get('main.modules_courses') }}</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
    ...
    <div class="row">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                {!! Form::open(['method'=>'PUT','url'=>'admin/modules_courses/'.$module_course->id,'id'=>'addModulesForm','files'=>true]) !!}
                <div class="form-body">
