    ...
    <div class="row">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                {!! Form::open(['method'=>'POST','url'=>'admin/my_courses','class'=>"form-horizontal"]) !!}
                <div class="form-body">
                    ...
                    <div class="form-group col-lg-3 text-center" style="margin-top:25px;">
                        <input type="checkbox" class="make-switch" name="old" value=1 checked data-size="small"
                               data-on-color="success" data-on-text="{{ Lang::get('main.old') }}" data-off-color="default"
                               data-off-text="{{ Lang::get('main.new') }}">
                    </div>
                    <div class="form-group col-lg-12">
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <div class="input-group date margin-bottom-5" data-date-format="yyyy-mm-dd">
                            <input type="text" class="form-control form-filter input-sm expire_date"
