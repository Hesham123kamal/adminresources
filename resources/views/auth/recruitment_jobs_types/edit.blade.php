...
@section('contentHeader')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{ URL('/admin/recruitment_jobs_types') }}">{{ Lang::get('main.recruitment_jobs_types') }}</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
    ...
    <div class="row">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                {!! Form::open(['method'=>'PUT','url'=>'admin/recruitment_jobs_types/'.$type->id,'class'=>"form-horizontal"]) !!}
                <div class="form-body">
                ...
                <div class="form-group col-lg-9">
                    ...
                    <select name="job" class="module_name sel2 form-control form-filter">
                        ...
                        @foreach($jobs as $id=>$title)
                            <option @if($type->recruitment_job_id==$id)  selected="selected"
                ...
                <div class="form-group col-lg-3 text-center" style="margin-top:25px;">
                    <input type="checkbox" class="make-switch" name="published" value="yes"
                           @if($type->published=="yes") checked @endif data-size="small" data-on-color="success"
                ...
                <div class="form-group col-lg-12">
                    ...
                    <select name="type" class="module_name sel2 form-control form-filter">
                        ...
                        @foreach($types_names as $id=>$name)
                            <option @if($type->recruitment_job_type_id==$id)  selected="selected"
