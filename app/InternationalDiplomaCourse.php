...
class InternationalDiplomaCourse extends Model
{
    public $timestamps = false;
    protected $connection = 'mysql2';
    protected $table = 'international_diplomas_courses';
    ...
    public function international_diploma()
    {
        return $this->belongsTo('App\InternationalDiplomas');
    }
