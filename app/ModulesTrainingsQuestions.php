...
class ModulesTrainingsQuestions extends Model
{
    //
    use SoftDeletes;
    protected $connection = 'mysql2';
    protected $table = 'modules_trainings_questions';
    ...
    public function ModulesTrainingsQuestionsDetails(){
        if($this->type=='true_false'){
            return $this->hasOne('App\ModulesTrainingsQuestionsDetails','question_id')->orderBy('id','ASC');
        }else{
            return $this->hasMany('App\ModulesTrainingsQuestionsDetails','question_id')->orderBy('id','ASC');
        }
    }
}
