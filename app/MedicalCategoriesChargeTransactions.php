...
class MedicalCategoriesChargeTransactions extends Model
{
    //
    public $timestamps = false;
    protected $connection = 'mysql2';
    protected $table = 'medical_categories_charge_transactions';
    /*
             *
    ...
    protected static function boot()
    {
        ...
        static::deleted(function ($model) {
            deleteChargeTransactionFromCRM($model->id,'medical transaction');
            updateAcademyChargeTransaction($model->user_id);
